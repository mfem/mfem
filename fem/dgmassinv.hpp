...
protected:
   ...
   Array<fptype> B_; ///< Inverse of change of basis.
   Array<fptype> Bt_; ///< Inverse of change of basis, transposed.
   ...
   fptype rel_tol = 1e-12; ///< Relative CG tolerance.
   fptype abs_tol = 1e-12; ///< Absolute CG tolerance.
...
public:
   ...
   void SetRelTol(const fptype rel_tol_);
   /// Set the absolute tolerance.
   void SetAbsTol(const fptype abs_tol_);
   /// Set the maximum number of iterations.
   void SetMaxIter(const fptype max_iter_);
