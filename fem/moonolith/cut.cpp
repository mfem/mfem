                                           ...
                                           IntegrationRule &to_quadrature)
{
   ...
   const bool from_is_linear = (from_type == Geometry::CUBE && from_trans.OrderW() <= 2) || from_trans.OrderW() <= 1;
   const bool to_is_linear = (to_type == Geometry::CUBE && to_trans.OrderW() <= 2) || to_trans.OrderW() <= 1;
