...
void ADQFunctionJ::QFunctionDD(const Vector &vparam, const Vector &uu,
                               DenseMatrix &jac)
{
...
void ADQFunctionH::QFunctionDD(const Vector &vparam, const Vector &uu,
                               DenseMatrix &jac)
{
...
double ADNonlinearFormIntegratorH::GetElementEnergy(const mfem::FiniteElement &
                                                    el,
...
void ADNonlinearFormIntegratorH::AssembleElementVector(const mfem::FiniteElement
                                                       & el,
                                                       mfem::ElementTransformation & Tr,
...
void ADNonlinearFormIntegratorH::AssembleElementGrad(const mfem::FiniteElement &
                                                     el,
                                                     mfem::ElementTransformation & Tr,
                                                     const mfem::Vector & elfun,
