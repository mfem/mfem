   ...
   DenseMatrix &elmat)
{
   int dof = el.GetDof();
   int spaceDim = Trans.GetSpaceDim();
   int vdim = std::max(spaceDim, el.GetInterpDim());
   ...
   ElementTransformation &Trans, DenseMatrix &elmat)
{
       ...
       && trial_fe.GetRangeType() == FiniteElement::VECTOR)
   {
      ...
      int spaceDim = Trans.GetSpaceDim();
      int vdim = std::max(spaceDim, trial_fe.GetInterpDim());
      int trial_dof = trial_fe.GetDof();
      int test_dof = test_fe.GetDof();
      double w;
            ...
            && trial_fe.GetRangeType() == FiniteElement::VECTOR)
   {
      ...
      int spaceDim = Trans.GetSpaceDim();
      int trial_vdim = std::max(spaceDim, trial_fe.GetInterpDim());
      int test_vdim = std::max(spaceDim, test_fe.GetInterpDim());
      int trial_dof = trial_fe.GetDof();
      int test_dof = test_fe.GetDof();
      double w;
