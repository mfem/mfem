                 ...
                 const fptype *y)
{
   ...
   MFEM_SHARED fptype s_dot[NB*NB];
   s_dot[tid] = 0.0;
                   ...
                   const int d1d = 0)
{
   ...
   MFEM_SHARED fptype sB[MD1*MD1];
   MFEM_SHARED fptype sm0[MD1*MD1];
   MFEM_SHARED fptype sm1[MD1*MD1];
                   ...
                   const int d1d = 0)
{
   ...
   MFEM_SHARED fptype sB[MD1*MD1];
   MFEM_SHARED fptype sm0[MD1*MD1*MD1];
   MFEM_SHARED fptype sm1[MD1*MD1*MD1];
