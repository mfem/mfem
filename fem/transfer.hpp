...
protected:
   ...
   public:
      ...
      virtual void SetRelTol(fptype p_rtol_) = 0;
      /// @brief Sets absolute tolerance in preconditioned conjugate gradient
      /// solver.
      ///
      /// Only used for H1 spaces.
      virtual void SetAbsTol(fptype p_atol_) = 0;
   protected:
   ...
   public:
      ...
      virtual void SetRelTol(fptype p_rtol_) { } ///< No-op.
      virtual void SetAbsTol(fptype p_atol_) { } ///< No-op.
   };
   ...
   public:
      ...
      /// is also provided as an Operator by L2Prolongation.
      virtual void ProlongateTranspose(const Vector& x, Vector& y) const;
      virtual void SetRelTol(fptype p_rtol_);
      virtual void SetAbsTol(fptype p_atol_);
   protected:
