...
public:
   ParSesquilinearForm(ParFiniteElementSpace *pf,
    ...
    /** @brief Create a ParSesquilinear on the ParFiniteElementSpace @a pf, using the
       same integrators as the ParSesquilinear @a bf. **/
...
public:
   SesquilinearForm(FiniteElementSpace *fes,
    ...
    /** @brief Create a Sesquilinear on the FiniteElementSpace @a f, using the
       same integrators as the Sesquilinear @a bf. **/
