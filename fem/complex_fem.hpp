...
public:
   ...
   ComplexGridFunction &operator=(const std::complex<fptype> & value)
...
public:
   ...
   std::complex<fptype> operator()(const ComplexGridFunction &gf) const;
};
...
public:
   ...
   ParComplexGridFunction &operator=(const std::complex<fptype> & value)
   ...
   virtual fptype ComputeL2Error(Coefficient &exsolr, Coefficient &exsoli,
                                 const IntegrationRule *irs[] = NULL) const
   {
      fptype err_r = pgfr->ComputeL2Error(exsolr, irs);
      fptype err_i = pgfi->ComputeL2Error(exsoli, irs);
      return sqrt(err_r * err_r + err_i * err_i);
   }

   virtual fptype ComputeL2Error(VectorCoefficient &exsolr,
                                 VectorCoefficient &exsoli,
                                 const IntegrationRule *irs[] = NULL,
                                 Array<int> *elems = NULL) const
   {
      fptype err_r = pgfr->ComputeL2Error(exsolr, irs, elems);
      fptype err_i = pgfi->ComputeL2Error(exsoli, irs, elems);
      return sqrt(err_r * err_r + err_i * err_i);
   }
...
public:
   ...
   std::complex<fptype> operator()(const ParComplexGridFunction &gf) const;
