...
void ComplexNormalEquations::Init()
{
...
void ComplexNormalEquations::ComputeOffsets()
{
...
void ComplexNormalEquations::AllocMat()
{
...
void ComplexNormalEquations::AddTrialIntegrator(
...
/// Adds new Domain BF Integrator. Assumes ownership of @a bfi.
void ComplexNormalEquations::AddTestIntegrator(
   BilinearFormIntegrator *bfi_r,
   BilinearFormIntegrator *bfi_i,
...
void ComplexNormalEquations::AddDomainLFIntegrator(
...
void ComplexNormalEquations::BuildProlongation()
{
...
void ComplexNormalEquations::ConformingAssemble()
{
   Finalize(0);
...
void ComplexNormalEquations::Assemble(int skip_zeros)
{
...
void ComplexNormalEquations::RecoverFEMSolution(const Vector &X,
                                                Vector &x)
{
