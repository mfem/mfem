...
static void HdivDLFAssemble2D(
   const int ne, const int d, const int q, const int *markers, const fptype *bo,
   const fptype *bc, const fptype *j, const fptype *weights,
   const Vector &coeff, fptype *y)
{
   ...
   mfem::forall_3D(ne, q, q, vdim, [=] MFEM_HOST_DEVICE (int e)
   {
      ...
      MFEM_SHARED fptype sBot[Q*D];
      MFEM_SHARED fptype sBct[Q*D];
      MFEM_SHARED fptype sQQ[vdim*Q*Q];
      MFEM_SHARED fptype sQD[vdim*Q*D];
      ...
      {
         const fptype cst_val_0 = C(0,0,0,0);
         const fptype cst_val_1 = C(1,0,0,0);
         MFEM_FOREACH_THREAD(y,y,q)
         {
            MFEM_FOREACH_THREAD(x,x,q)
            {
               const fptype J0 = J(x,y,0,vd,e);
               const fptype J1 = J(x,y,1,vd,e);
               const fptype C0 = cst ? cst_val_0 : C(0,x,y,e);
               const fptype C1 = cst ? cst_val_1 : C(1,x,y,e);
   ...
   const Vector &coeff, fptype *y)
{
   ...
   mfem::forall_3D(ne, q, q, vdim, [=] MFEM_HOST_DEVICE (int e)
   {
      ...
      MFEM_SHARED fptype sm0[vdim*Q*Q*Q];
      MFEM_SHARED fptype sm1[vdim*Q*Q*Q];
      ...
      MFEM_FOREACH_THREAD(vd,z,vdim)
      {
         const fptype cst_val_0 = C(0,0,0,0,0);
         const fptype cst_val_1 = C(1,0,0,0,0);
         const fptype cst_val_2 = C(2,0,0,0,0);
         MFEM_FOREACH_THREAD(y,y,q)
         {
            MFEM_FOREACH_THREAD(x,x,q)
            {
               for (int z = 0; z < q; ++z)
               {
                  const fptype J0 = J(x,y,z,0,vd,e);
                  const fptype J1 = J(x,y,z,1,vd,e);
                  const fptype J2 = J(x,y,z,2,vd,e);
                  const fptype C0 = cst ? cst_val_0 : C(0,x,y,z,e);
                  const fptype C1 = cst ? cst_val_1 : C(1,x,y,z,e);
                  const fptype C2 = cst ? cst_val_2 : C(2,x,y,z,e);
                            ...
                            Vector &y)
{
   ...
   const fptype *Bo = maps_o.B.Read();
   const fptype *Bc = maps_c.B.Read();
