      ...
      MFEM_FOREACH_THREAD(qx,x,Q1D)
      {
         MFEM_FOREACH_THREAD(qy,y,Q1D)
         {
            ...
            if (coeffDim == 3 || coeffDim == 4) // Matrix coefficient
            {
               ...
               const fptype M11 = C(0,qx,qy,e);
               const fptype M12 = C(1,qx,qy,e);
               const fptype M21 = symmetric ? M12 : C(2,qx,qy,e);
               const fptype M22 = symmetric ? C(2,qx,qy,e) : C(3,qx,qy,e);
               const fptype R11 = M11*J22 - M12*J12;
               const fptype R21 = M21*J22 - M22*J12;
               const fptype R12 = -M11*J21 + M12*J11;
               const fptype R22 = -M21*J21 + M22*J11;
            ...
            {
               const fptype C1 = const_c ? C(0,0,0,0) : C(0,qx,qy,e);
                           ...
                           Vector &d)
{
   ...
   mfem::forall_2D(NE, Q1D, Q1D, [=] MFEM_HOST_DEVICE (int e)
   {
      MFEM_FOREACH_THREAD(qx,x,Q1D)
      {
         MFEM_FOREACH_THREAD(qy,y,Q1D)
         {
            const fptype wq = W(qx,qy);
            const fptype J11 = J(qx,qy,0,0,e);
            const fptype J21 = J(qx,qy,1,0,e);
            const fptype J31 = J(qx,qy,2,0,e);
            const fptype J12 = J(qx,qy,0,1,e);
            const fptype J22 = J(qx,qy,1,1,e);
            const fptype J32 = J(qx,qy,2,1,e);
            ...
            const fptype coeff = const_c ? C(0,0,0) : C(qx,qy,e);
            const fptype alpha = wq * coeff * iw;
         ...
         MFEM_FOREACH_THREAD(qy,y,Q1D)
         {
            MFEM_FOREACH_THREAD(qz,z,Q1D)
            {
               ...
               if (coeffDim == 6 || coeffDim == 9) // Matrix coefficient version
               {
                  ...
                  const fptype M11 = C(0, qx,qy,qz, e);
                  const fptype M12 = C(1, qx,qy,qz, e);
                  const fptype M13 = C(2, qx,qy,qz, e);
                  const fptype M21 = (!symmetric) ? C(3, qx,qy,qz, e) : M12;
                  const fptype M22 = (!symmetric) ? C(4, qx,qy,qz, e) : C(3, qx,qy,qz, e);
                  const fptype M23 = (!symmetric) ? C(5, qx,qy,qz, e) : C(4, qx,qy,qz, e);
                  const fptype M31 = (!symmetric) ? C(6, qx,qy,qz, e) : M13;
                  const fptype M32 = (!symmetric) ? C(7, qx,qy,qz, e) : M23;
                  const fptype M33 = (!symmetric) ? C(8, qx,qy,qz, e) : C(5, qx,qy,qz, e);
               ...
               {
                  const fptype C1 = const_c ? C(0,0,0,0,0) : C(0,qx,qy,qz,e);
                  const fptype C2 = const_c ? C(0,0,0,0,0) :
                                    (coeffDim == 3 ? C(1,qx,qy,qz,e) : C(0,qx,qy,qz,e));
                  const fptype C3 = const_c ? C(0,0,0,0,0) :
