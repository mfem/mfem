                               ...
                               for (int j3 = 0; j3 < D1D; ++j3)
                               {
                                  ...
                                  for (int k1 = 0; k1 < Q1D; ++k1)
                                  {
                                     for (int k2 = 0; k2 < Q1D; ++k2)
                                     {
                                        ...
                                        {
                                           real_t bbgi = r_G[k1][i1] *
                                                         r_B[k2][i2] *
                                                         r_B[k3][i3];
                                           real_t bgbi = r_B[k1][i1] *
                                                         r_G[k2][i2] *
                                                         r_B[k3][i3];
                                           real_t gbbi = r_B[k1][i1] *
                                                         r_B[k2][i2] *
                                                         r_G[k3][i3];
                                           real_t bbgj = r_G[k1][j1] *
                                                         r_B[k2][j2] *
                                                         r_B[k3][j3];
                                           real_t bgbj = r_B[k1][j1] *
                                                         r_G[k2][j2] *
                                                         r_B[k3][j3];
                                           real_t gbbj = r_B[k1][j1] *
                                                         r_B[k2][j2] *
                                                         r_G[k3][j3];
