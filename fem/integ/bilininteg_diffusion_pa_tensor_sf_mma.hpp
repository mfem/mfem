                                              ...
                                              Vector &y_)
{
   ...
   mfem::forall_3D(NE, nthreads, 1, 1, [=] MFEM_HOST_DEVICE (int e)
   {
      ...
      tensor_sf_mma::LoadBG<MD1, MQ1>(D1D, Q1D, B, G, BG);
      ...
      const int thread = tensor_sf_mma::getThreadIdx();
      ...
      tensor_sf_mma::LoadBtGt<MD1, MQ1>(D1D, Q1D, B, G, BG);
      MFEM_SYNC_THREAD;
      tensor_sf_mma::GradZt<MD1, MQ1>(D1D, Q1D, BG, sm0, sm1);
      MFEM_SYNC_THREAD;
      tensor_sf_mma::GradYt<MD1, MQ1>(D1D, Q1D, BG, sm1, sm0);
      MFEM_SYNC_THREAD;
      tensor_sf_mma::GradXt<MD1, MQ1>(D1D, Q1D, BG, sm0, Y, e);
   });
}
                                              ...
                                              Vector &y_)
{
   ...
   {
      constexpr int MQ1 = T_Q1D, MD1 = T_D1D;
      MFEM_SHARED real_t sm0[2][MDQ * MDQ * MDQ];
      MFEM_SHARED real_t sm1[2][MDQ * MDQ * MDQ];
      MFEM_SHARED real_t BG[2][MD1 * MQ1];
...

      {
         ...
         if (tid < Q1D * Q1D)
         {
            ...
            const real_t O12 = SYM ? O21 : D(q, 2, e);
            const real_t O22 = SYM ? D(q, 2, e) : D(q, 3, e);
      ...
      tensor_sf_mma::LoadBtGt<MD1, MQ1>(D1D, Q1D, B, G, BG);
      MFEM_SYNC_THREAD;
      tensor_sf_mma::GradYt2D<MD1, MQ1, MDQ>(D1D, Q1D, BG, sm1, sm0);
      MFEM_SYNC_THREAD;
      tensor_sf_mma::GradXt2D<MD1, MQ1, MDQ>(D1D, Q1D, BG, sm0, Y, e);
   });
}
