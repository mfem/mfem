...
#else
      return SmemPAMassAssembleDiagonal2D(NE,B,D,Y,D1D,Q1D,1);
#endif
   }
   else if (dim == 3)
   {
                 ...
                 Vector &Y)
{
   ...
   else if (dim == 2)
   {
      ...
      switch (id)
      {
         ...
         default:   return PAMassApply2D(NE,B,D,X,Y,D1D,Q1D);
      }
#else
      return SmemPAMassApply2D(NE,B,D,X,Y,D1D,Q1D,1);
#endif
   }
   else if (dim == 3)
   {
      ...
      switch (id)
      {
         ...
         default:   return PAMassApply3D(NE,B,D,X,Y,D1D,Q1D);
      }
#else
