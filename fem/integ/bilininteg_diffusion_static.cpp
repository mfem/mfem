...
void StaticSmemPADiffusionApply2DKernel(const int NE, const bool symmetric,
                                        const Array<double> &b_,
                                        const Array<double> &g_,
                                        const Vector &d_, const Vector &x_,
                                        Vector &y_)
{
...
void StaticSmemPADiffusionApply2D(const int NE, const bool symm,
                                  ...
                                  const int Q1D)
{
   ...
   {
      case 0x22:
         return StaticSmemPADiffusionApply2DKernel<2, 2, 16>(NE, symm, B, G, D, X,
                                                             Y);
      case 0x23:
         return StaticSmemPADiffusionApply2DKernel<2, 3, 16>(NE, symm, B, G, D, X,
                                                             Y);
      case 0x33:
         return StaticSmemPADiffusionApply2DKernel<3, 3, 16>(NE, symm, B, G, D, X,
                                                             Y);
      case 0x34:
         return StaticSmemPADiffusionApply2DKernel<3, 4, 8>(NE, symm, B, G, D, X, Y);
      case 0x44:
         return StaticSmemPADiffusionApply2DKernel<4, 4, 8>(NE, symm, B, G, D, X, Y);
      case 0x45:
         return StaticSmemPADiffusionApply2DKernel<4, 5, 4>(NE, symm, B, G, D, X, Y);
         // case 0x55: return
         // StaticSmemPADiffusionApply2DKernel<5,5,8>(NE,symm,B,G,D,X,Y); case 0x66:
         // return StaticSmemPADiffusionApply2DKernel<6,6,4>(NE,symm,B,G,D,X,Y); case
         // 0x77: return
         // StaticSmemPADiffusionApply2DKernel<7,7,4>(NE,symm,B,G,D,X,Y); case 0x88:
         // return StaticSmemPADiffusionApply2DKernel<8,8,2>(NE,symm,B,G,D,X,Y); case
         // 0x99: return
         // StaticSmemPADiffusionApply2DKernel<9,9,2>(NE,symm,B,G,D,X,Y);
   }
...
void StaticSmemPADiffusionApply3DKernel(const int NE, const bool symmetric,
                                        const Array<double> &b_,
                                        const Array<double> &g_,
                                        const Vector &d_, const Vector &x_,
...
void StaticSmemPADiffusionApply3D(const int NE, const bool symm,
                                  const Array<double> &B,
                                  const Array<double> &G, const Vector &D,
                                  const Vector &X, Vector &Y, const int D1D,
                                  const int Q1D)
{
   ...
   {
      case 0x22:
         return StaticSmemPADiffusionApply3DKernel<2, 2>(NE, symm, B, G, D, X, Y);
      case 0x23:
         return StaticSmemPADiffusionApply3DKernel<2, 3>(NE, symm, B, G, D, X, Y);
      case 0x33:
         return StaticSmemPADiffusionApply3DKernel<3, 3>(NE, symm, B, G, D, X, Y);
      case 0x34:
         return StaticSmemPADiffusionApply3DKernel<3, 4>(NE, symm, B, G, D, X, Y);
      case 0x44:
         return StaticSmemPADiffusionApply3DKernel<4, 4>(NE, symm, B, G, D, X, Y);
      case 0x45:
         return StaticSmemPADiffusionApply3DKernel<4, 5>(NE, symm, B, G, D, X, Y);
      case 0x56:
         return StaticSmemPADiffusionApply3DKernel<5, 6>(NE, symm, B, G, D, X, Y);
      case 0x67:
         return StaticSmemPADiffusionApply3DKernel<6, 7>(NE, symm, B, G, D, X, Y);
      case 0x78:
         return StaticSmemPADiffusionApply3DKernel<7, 8>(NE, symm, B, G, D, X, Y);
         // default: return
         // StaticSmemPADiffusionApply3DKernel<>(NE,symm,B,G,D,X,Y,D1D,Q1D);
   }
   MFEM_ABORT("Unknown kernel: 0x" << std::hex << id << std::dec);
}
