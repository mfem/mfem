                            ...
                            Vector &op)
{
   ...
   mfem::forall_2D(NE, Q1D, Q1D, [=] MFEM_HOST_DEVICE (int e)
   {
      MFEM_FOREACH_THREAD(qx,x,Q1D)
      {
         ...
         {
            const fptype J11 = J(qx,qy,0,0,e);
            const fptype J21 = J(qx,qy,1,0,e);
            const fptype J12 = J(qx,qy,0,1,e);
            const fptype J22 = J(qx,qy,1,1,e);
            const fptype w_detJ = W(qx,qy) / ((J11*J22) - (J21*J12));

            if (coeffDim == 3 || coeffDim == 4) // Matrix coefficient version
            {
               // First compute entries of R = MJ
               const fptype M11 = coeff(i11,qx,qy,e);
               const fptype M12 = (!symmetric) ? coeff(i12,qx,qy,e) : coeff(1,qx,qy,e);
               const fptype M21 = (!symmetric) ? coeff(i21,qx,qy,e) : M12;
               const fptype M22 = (!symmetric) ? coeff(i22,qx,qy,e) : coeff(2,qx,qy,e);

               // J^{-1} M^T
               const fptype R11 = ( J22*M11 - J12*M12); // 1,1
               const fptype R12 = ( J22*M21 - J12*M22); // 1,2
               const fptype R21 = (-J21*M11 + J11*M12); // 2,1
               const fptype R22 = (-J21*M21 + J11*M22); // 2,2
            ...
            {
               const fptype D1 = coeff(0,qx,qy,e);
               const fptype D2 = coeff(1,qx,qy,e);
               const fptype R11 = D1*J11;
               const fptype R12 = D1*J12;
               const fptype R21 = D2*J21;
               const fptype R22 = D2*J22;
   ...
   mfem::forall_3D(NE, Q1D, Q1D, Q1D, [=] MFEM_HOST_DEVICE (int e)
   {
      MFEM_FOREACH_THREAD(qx,x,Q1D)
      {
         MFEM_FOREACH_THREAD(qy,y,Q1D)
         {
            ...
            {
               const fptype J11 = J(qx,qy,qz,0,0,e);
               const fptype J21 = J(qx,qy,qz,1,0,e);
               const fptype J31 = J(qx,qy,qz,2,0,e);
               const fptype J12 = J(qx,qy,qz,0,1,e);
               const fptype J22 = J(qx,qy,qz,1,1,e);
               const fptype J32 = J(qx,qy,qz,2,1,e);
               const fptype J13 = J(qx,qy,qz,0,2,e);
               const fptype J23 = J(qx,qy,qz,1,2,e);
               const fptype J33 = J(qx,qy,qz,2,2,e);
               ...
               if (coeffDim == 6 || coeffDim == 9) // Matrix coefficient version
               {
                  ...
                  const fptype M11 = (!symmetric) ? coeff(i11,qx,qy,qz,e) : coeff(0,qx,qy,qz,e);
                  const fptype M12 = (!symmetric) ? coeff(i12,qx,qy,qz,e) : coeff(1,qx,qy,qz,e);
                  const fptype M13 = (!symmetric) ? coeff(i13,qx,qy,qz,e) : coeff(2,qx,qy,qz,e);
                  const fptype M21 = (!symmetric) ? coeff(i21,qx,qy,qz,e) : M12;
                  const fptype M22 = (!symmetric) ? coeff(i22,qx,qy,qz,e) : coeff(3,qx,qy,qz,e);
                  const fptype M23 = (!symmetric) ? coeff(i23,qx,qy,qz,e) : coeff(4,qx,qy,qz,e);
                  const fptype M31 = (!symmetric) ? coeff(i31,qx,qy,qz,e) : M13;
                  const fptype M32 = (!symmetric) ? coeff(i32,qx,qy,qz,e) : M23;
                  const fptype M33 = (!symmetric) ? coeff(i33,qx,qy,qz,e) : coeff(5,qx,qy,qz,e);

                  const fptype R11 = M11*J11 + M21*J21 + M31*J31;
                  const fptype R12 = M11*J12 + M21*J22 + M31*J32;
                  const fptype R13 = M11*J13 + M21*J23 + M31*J33;
                  const fptype R21 = M12*J11 + M22*J21 + M32*J31;
                  const fptype R22 = M12*J12 + M22*J22 + M32*J32;
                  const fptype R23 = M12*J13 + M22*J23 + M32*J33;
                  const fptype R31 = M13*J11 + M23*J21 + M33*J31;
                  const fptype R32 = M13*J12 + M23*J22 + M33*J32;
                  const fptype R33 = M13*J13 + M23*J23 + M33*J33;
               ...
               {
                  const fptype D1 = coeff(0,qx,qy,qz,e);
                  const fptype D2 = coeff(1,qx,qy,qz,e);
                  const fptype D3 = coeff(2,qx,qy,qz,e);
   ...
   mfem::forall(NE, [=] MFEM_HOST_DEVICE (int e)
   {
      ...
      for (int c = 0; c < VDIM; ++c)  // loop over x, y trial components
      {
         ...
         for (int dy = 0; dy < D1Dy; ++dy)
         {
            ...
            for (int qy = 0; qy < Q1D; ++qy)
            {
               const fptype wy = trialHcurl ? ((c == 1) ? Bo(qy,dy) : Bc(qy,dy)) :
      ...
      for (int qy = 0; qy < Q1D; ++qy)
      {
         for (int qx = 0; qx < Q1D; ++qx)
         {
            const fptype O11 = op(0,qx,qy,e);
            const fptype O12 = scalarCoeff ? 0.0 : op(i12,qx,qy,e);
            const fptype O21 = scalarCoeff ? 0.0 : op(i21,qx,qy,e);
            const fptype O22 = scalarCoeff ? O11 : op(3,qx,qy,e);
      ...
      for (int c = 0; c < VDIM; ++c)  // loop over x, y test components
      {
         ...
         for (int qy = 0; qy < Q1D; ++qy)
         {
            fptype massX[DofQuadLimits::HDIV_MAX_D1D];
            for (int dx = 0; dx < D1Dx; ++dx)
            {
               massX[dx] = 0.0;
            }
            ...
            for (int dy = 0; dy < D1Dy; ++dy)
            {
               const fptype wy = trialHcurl ? ((c == 1) ? Bct(dy,qy) : Bot(dy,qy)) :
   ...
   mfem::forall(NE, [=] MFEM_HOST_DEVICE (int e)
   {
      ...
      for (int c = 0; c < VDIM; ++c)  // loop over x, y, z trial components
      {
         ...
         for (int dz = 0; dz < D1Dz; ++dz)
         {
            ...
            for (int qz = 0; qz < Q1D; ++qz)
            {
               const fptype wz = trialHcurl ? ((c == 2) ? Bo(qz,dz) : Bc(qz,dz)) :
      ...
      for (int qz = 0; qz < Q1D; ++qz)
      {
         for (int qy = 0; qy < Q1D; ++qy)
         {
            for (int qx = 0; qx < Q1D; ++qx)
            {
               const fptype O11 = op(0,qx,qy,qz,e);
               const fptype O12 = scalarCoeff ? 0.0 : op(i12,qx,qy,qz,e);
               const fptype O13 = scalarCoeff ? 0.0 : op(i13,qx,qy,qz,e);
               const fptype O21 = scalarCoeff ? 0.0 : op(i21,qx,qy,qz,e);
               const fptype O22 = scalarCoeff ? O11 : op(4,qx,qy,qz,e);
               const fptype O23 = scalarCoeff ? 0.0 : op(i23,qx,qy,qz,e);
               const fptype O31 = scalarCoeff ? 0.0 : op(i31,qx,qy,qz,e);
               const fptype O32 = scalarCoeff ? 0.0 : op(i32,qx,qy,qz,e);
               const fptype O33 = scalarCoeff ? O11 : op(8,qx,qy,qz,e);
      ...
      for (int qz = 0; qz < Q1D; ++qz)
      {
         fptype massXY[DofQuadLimits::HDIV_MAX_D1D][DofQuadLimits::HDIV_MAX_D1D];
         ...
         for (int c = 0; c < VDIM; ++c)  // loop over x, y, z test components
         {
            ...
            for (int dz = 0; dz < D1Dz; ++dz)
            {
               const fptype wz = trialHcurl ? ((c == 2) ? Bct(dz,qz) : Bot(dz,qz)) :
