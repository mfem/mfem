                                         ...
                                         const int q1d = 0)
{
   ...
   mfem::forall_2D_batch(NE, Q1D, Q1D, NBZ, [=] MFEM_HOST_DEVICE (int e)
   {
      ...
      MFEM_SHARED fptype QDZ[NBZ][MQ1][MD1];
      fptype (*QD)[MD1] = (fptype (*)[MD1])(QDZ + tidz);
      if (tidz == 0)
      {
                               ...
                               int q1d = 0)
{
   ...
   MFEM_SHARED fptype BBt[MQ1*MD1];
   fptype (*B)[MD1] = (fptype (*)[MD1]) BBt;
   fptype (*Bt)[MQ1] = (fptype (*)[MQ1]) BBt;
   MFEM_SHARED fptype sm0[NBZ][MDQ*MDQ];
   MFEM_SHARED fptype sm1[NBZ][MDQ*MDQ];
   fptype (*X)[MD1] = (fptype (*)[MD1]) (sm0 + tidz);
   fptype (*DQ)[MQ1] = (fptype (*)[MQ1]) (sm1 + tidz);
   fptype (*QQ)[MQ1] = (fptype (*)[MQ1]) (sm0 + tidz);
   fptype (*QD)[MD1] = (fptype (*)[MD1]) (sm1 + tidz);
                           ...
                           const int q1d)
{
   ...
   auto B = ConstDeviceMatrix(b_, Q1D, D1D);
   auto Bt = ConstDeviceMatrix(bt_, D1D, Q1D);
   auto D = DeviceTensor<4,const fptype>(d_, Q1D, Q1D, Q1D, NE);
   auto X = DeviceTensor<4,const fptype>(x_, D1D, D1D, D1D, NE);
   auto Y = DeviceTensor<4,fptype>(y_, D1D, D1D, D1D, NE);
                               ...
                               const int q1d = 0)
{
   ...
   MFEM_SHARED fptype sDQ[MQ1*MD1];
   fptype (*B)[MD1] = (fptype (*)[MD1]) sDQ;
   fptype (*Bt)[MQ1] = (fptype (*)[MQ1]) sDQ;
   MFEM_SHARED fptype sm0[MDQ*MDQ*MDQ];
   MFEM_SHARED fptype sm1[MDQ*MDQ*MDQ];
   fptype (*X)[MD1][MD1]   = (fptype (*)[MD1][MD1]) sm0;
   fptype (*DDQ)[MD1][MQ1] = (fptype (*)[MD1][MQ1]) sm1;
   fptype (*DQQ)[MQ1][MQ1] = (fptype (*)[MQ1][MQ1]) sm0;
   fptype (*QQQ)[MQ1][MQ1] = (fptype (*)[MQ1][MQ1]) sm1;
   fptype (*QQD)[MQ1][MD1] = (fptype (*)[MQ1][MD1]) sm0;
   fptype (*QDD)[MD1][MD1] = (fptype (*)[MD1][MD1]) sm1;
   MFEM_FOREACH_THREAD(dy,y,D1D)
   {
      MFEM_FOREACH_THREAD(dx,x,D1D)
      {
