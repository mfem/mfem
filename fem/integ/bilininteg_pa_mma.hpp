...
#else
   (void)MAP; (void)M; (void)ndof; (void)NB; (void)B; (void)X; (void)U;
...
#else
   (void)MAP; (void)M; (void)ndof; (void)NB; (void)B; (void)U; (void)Y;
   (void)e0; (void)NE;
#endif
}
...
#else
   (void)MAP; (void)M; (void)ndof; (void)NB; (void)B0; (void)B1; (void)B2;
