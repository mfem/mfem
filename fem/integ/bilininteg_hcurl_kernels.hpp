                                              ...
                                              Vector &diag)
{
   ...
   mfem::forall_3D(NE, Q1D, Q1D, Q1D, [=] MFEM_HOST_DEVICE (int e)
   {
      ...
      MFEM_SHARED fptype sBo[MQ1D][MD1D];
      MFEM_SHARED fptype sBc[MQ1D][MD1D];

      fptype op3[3];
      MFEM_SHARED fptype sop[3][MQ1D][MQ1D];
      ...
      for (int c = 0; c < VDIM; ++c)  // loop over x, y, z components
      {
         ...
         for (int qz=0; qz < Q1D; ++qz)
         {
            ...
            {
               const fptype wz = ((c == 2) ? sBo[qz][dz] : sBc[qz][dz]);
               ...
               MFEM_FOREACH_THREAD(dy,y,D1Dy)
               {
                  MFEM_FOREACH_THREAD(dx,x,D1Dx)
                  {
                     ...
                     {
                        const fptype wy = ((c == 1) ? sBo[qy][dy] : sBc[qy][dy]);

                        for (int qx = 0; qx < Q1D; ++qx)
                        {
                           const fptype wx = ((c == 0) ? sBo[qx][dx] : sBc[qx][dx]);
                                   ...
                                   Vector &y)
{
   ...
   mfem::forall_3D(NE, Q1D, Q1D, Q1D, [=] MFEM_HOST_DEVICE (int e)
   {
      ...
      fptype op9[9];
      MFEM_SHARED fptype sop[9*MQ1D*MQ1D];
      MFEM_SHARED fptype mass[MQ1D][MQ1D][3];

      MFEM_SHARED fptype sX[MD1D][MD1D][MD1D];
                  ...
                  MFEM_FOREACH_THREAD(dx,x,D1Dx)
                  {
                     for (int qy = 0; qy < Q1D; ++qy)
                     {
                        ...
                        for (int qx = 0; qx < Q1D; ++qx)
                        {
                           ...
                           const fptype m_c = (sop[id1] * mass[qy][qx][0]) + (sop[id2] * mass[qy][qx][1]) +
                                         ...
                                         Vector &diag)
{
   ...
   mfem::forall(NE, [=] MFEM_HOST_DEVICE (int e)
   {
      ...
      for (int c = 0; c < VDIM; ++c)  // loop over x, y, z components
      {
            ...
            for (int qy = 0; qy < Q1D; ++qy)
            {
               for (int dz = 0; dz < D1Dz; ++dz)
               {
                  ...
                  for (int qz = 0; qz < Q1D; ++qz)
                  {
                     ...
                     const fptype wDz = ((c == 2) ? Go(qz,dz) : Gc(qz,dz));
         ...
         fptype yt[MQ1D][MD1D][MD1D][9][3][3];
            ...
            for (int dz = 0; dz < D1Dz; ++dz)
            {
               for (int dy = 0; dy < D1Dy; ++dy)
               {
                  ...
                  for (int qy = 0; qy < Q1D; ++qy)
                  {
                     ...
                     const fptype wDy = ((c == 1) ? Go(qy,dy) : Gc(qy,dy));
            ...
            for (int dy = 0; dy < D1Dy; ++dy)
            {
               for (int dx = 0; dx < D1Dx; ++dx)
               {
                  for (int qx = 0; qx < Q1D; ++qx)
                  {
                     ...
                     const fptype wDx = ((c == 0) ? Go(qx,dx) : Gc(qx,dx));
                     ...
                     */
                     ...
                     if (c == 0)
                     {
                        ...
                        const fptype sumy = yt[qx][dy][dz][i22][2][0] - yt[qx][dy][dz][i23][1][1]
                     ...
                     else if (c == 1)
                     {
                        ...
                        const fptype d = (yt[qx][dy][dz][i11][2][0] * wx * wx)
                     ...
                     else
                     {
                        ...
                        const fptype d = (yt[qx][dy][dz][i11][0][2] * wx * wx)
                                             ...
                                             Vector &diag)
{
   ...
   mfem::forall_3D(NE, Q1D, Q1D, Q1D, [=] MFEM_HOST_DEVICE (int e)
   {
      ...
      MFEM_SHARED fptype sBo[MQ1D][MD1D];
      MFEM_SHARED fptype sBc[MQ1D][MD1D];
      MFEM_SHARED fptype sGo[MQ1D][MD1D];
      MFEM_SHARED fptype sGc[MQ1D][MD1D];
      ...
      for (int c = 0; c < VDIM; ++c)  // loop over x, y, z components
      {
         ...
         for (int qz=0; qz < Q1D; ++qz)
         {
            ...
            {
               const fptype wz = ((c == 2) ? sBo[qz][dz] : sBc[qz][dz]);
               const fptype wDz = ((c == 2) ? sGo[qz][dz] : sGc[qz][dz]);
               ...
               MFEM_FOREACH_THREAD(dy,y,D1Dy)
               {
                  MFEM_FOREACH_THREAD(dx,x,D1Dx)
                  {
                     ...
                     {
                        const fptype wy = ((c == 1) ? sBo[qy][dy] : sBc[qy][dy]);
                        const fptype wDy = ((c == 1) ? sGo[qy][dy] : sGc[qy][dy]);

                        for (int qx = 0; qx < Q1D; ++qx)
                        {
                           const fptype wx = ((c == 0) ? sBo[qx][dx] : sBc[qx][dx]);
                           const fptype wDx = ((c == 0) ? sGo[qx][dx] : sGc[qx][dx]);
                              ...
                              Vector &y)
{
   ...
   mfem::forall(NE, [=] MFEM_HOST_DEVICE (int e)
   {
      ...
      fptype curl[MQ1D][MQ1D][MQ1D][VDIM];
...

      {
         ...
         for (int dz = 0; dz < D1Dz; ++dz)
         {
            ...
            for (int dx = 0; dx < D1Dx; ++dx)
            {
               ...
               for (int qx = 0; qx < Q1D; ++qx)
               {
                  const fptype wx = Bc(qx,dx);
                  const fptype wDx = Gc(qx,dx);
                  for (int qy = 0; qy < Q1D; ++qy)
                  {
                     const fptype wy = massY[qy];
      ...
      for (int qz = 0; qz < Q1D; ++qz)
      {
         for (int qy = 0; qy < Q1D; ++qy)
         {
            for (int qx = 0; qx < Q1D; ++qx)
            {
               ...
               const fptype c1 = (O11 * curl[qz][qy][qx][0]) + (O12 * curl[qz][qy][qx][1]) +
                                 (O13 * curl[qz][qy][qx][2]);
               const fptype c2 = (O21 * curl[qz][qy][qx][0]) + (O22 * curl[qz][qy][qx][1]) +
                                 (O23 * curl[qz][qy][qx][2]);
               const fptype c3 = (O31 * curl[qz][qy][qx][0]) + (O32 * curl[qz][qy][qx][1]) +
                                 (O33 * curl[qz][qy][qx][2]);
      ...
      osc = 0;
      {
         ...
         for (int qz = 0; qz < Q1D; ++qz)
         {
            fptype gradXY12[MD1D][MD1D];
            fptype gradXY21[MD1D][MD1D];
            ...
            for (int qy = 0; qy < Q1D; ++qy)
            {
               ...
               for (int dy = 0; dy < D1Dy; ++dy)
               {
                  const fptype wy = Bct(dy,qy);
                  const fptype wDy = Gct(dy,qy);
            ...
            for (int dz = 0; dz < D1Dz; ++dz)
            {
               const fptype wz = Bct(dz,qz);
               const fptype wDz = Gct(dz,qz);
               for (int dy = 0; dy < D1Dy; ++dy)
               {
                  for (int dx = 0; dx < D1Dx; ++dx)
                  {
      ...
      // y component
      {
         ...
         for (int qz = 0; qz < Q1D; ++qz)
         {
            fptype gradXY02[MD1D][MD1D];
            fptype gradXY20[MD1D][MD1D];
            ...
            for (int qx = 0; qx < Q1D; ++qx)
            {
               ...
               for (int dx = 0; dx < D1Dx; ++dx)
               {
                  const fptype wx = Bct(dx,qx);
                  const fptype wDx = Gct(dx,qx);
      ...
      // z component
      {
         ...
         for (int qx = 0; qx < Q1D; ++qx)
         {
            fptype gradYZ01[MD1D][MD1D];
            fptype gradYZ10[MD1D][MD1D];
                                  ...
                                  Vector &y)
{
   ...
   auto device_kernel = [=] MFEM_DEVICE (int e)
   {
      ...
      MFEM_SHARED fptype sBo[MD1D][MQ1D];
      MFEM_SHARED fptype sBc[MD1D][MQ1D];
      MFEM_SHARED fptype sGc[MD1D][MQ1D];

      fptype ope[9];
      MFEM_SHARED fptype sop[9][MQ1D][MQ1D];
      MFEM_SHARED fptype curl[MQ1D][MQ1D][3];
      ...
      for (int qz=0; qz < Q1D; ++qz)
      {
               ...
               MFEM_FOREACH_THREAD(qy,y,Q1D)
               {
                  MFEM_FOREACH_THREAD(qx,x,Q1D)
                  {
                     ...
                     if (c == 0) // x component
                     {
                        ...
                        for (int dz = 0; dz < D1Dz; ++dz)
                        {
                           const fptype wz = sBc[dz][qz];
                           const fptype wDz = sGc[dz][qz];

                           for (int dy = 0; dy < D1Dy; ++dy)
                           {
                              const fptype wy = sBc[dy][qy];
                              const fptype wDy = sGc[dy][qy];

                              for (int dx = 0; dx < D1Dx; ++dx)
                              {
                                 const fptype wx = sX[dz][dy][dx] * sBo[dx][qx];
                                 u += wx * wDy * wz;
                                 v += wx * wy * wDz;
                              }
                           }
                     ...
                     else if (c == 1)  // y component
                     {
                        ...
                        for (int dz = 0; dz < D1Dz; ++dz)
                        {
                           ...
                           for (int dy = 0; dy < D1Dy; ++dy)
                           {
                              const fptype wy = sBo[dy][qy];

                              for (int dx = 0; dx < D1Dx; ++dx)
                              {
                                 const fptype t = sX[dz][dy][dx];
                                 const fptype wx = t * sBc[dx][qx];
                                 const fptype wDx = t * sGc[dx][qx];
         ...
         {
            const fptype wcz = sBc[dz][qz];
            const fptype wcDz = sGc[dz][qz];
            const fptype wz = (dz < D1D-1) ? sBo[dz][qz] : 0.0;
            ...
            MFEM_FOREACH_THREAD(dy,y,D1D)
            {
               MFEM_FOREACH_THREAD(dx,x,D1D)
               {
                  for (int qy = 0; qy < Q1D; ++qy)
                  {
                     const fptype wcy = sBc[dy][qy];
                     const fptype wcDy = sGc[dy][qy];
                     const fptype wy = (dy < D1D-1) ? sBo[dy][qy] : 0.0;

                     for (int qx = 0; qx < Q1D; ++qx)
                     {
                        const fptype O11 = sop[0][qx][qy];
                        const fptype O12 = sop[1][qx][qy];
                        const fptype O13 = sop[2][qx][qy];
                        const fptype O21 = symmetric ? O12 : sop[3][qx][qy];
                        const fptype O22 = symmetric ? sop[3][qx][qy] : sop[4][qx][qy];
                        const fptype O23 = symmetric ? sop[4][qx][qy] : sop[5][qx][qy];
                        const fptype O31 = symmetric ? O13 : sop[6][qx][qy];
                        const fptype O32 = symmetric ? O23 : sop[7][qx][qy];
                        const fptype O33 = symmetric ? sop[5][qx][qy] : sop[8][qx][qy];

                        const fptype c1 = (O11 * curl[qy][qx][0]) + (O12 * curl[qy][qx][1]) +
                                          (O13 * curl[qy][qx][2]);
                        const fptype c2 = (O21 * curl[qy][qx][0]) + (O22 * curl[qy][qx][1]) +
                                          (O23 * curl[qy][qx][2]);
                        const fptype c3 = (O31 * curl[qy][qx][0]) + (O32 * curl[qy][qx][1]) +
                                          (O33 * curl[qy][qx][2]);

                        const fptype wcx = sBc[dx][qx];
                        const fptype wDx = sGc[dx][qx];

                        if (dx < D1D-1)
                        {
                           // \hat{\nabla}\times\hat{u} is [0, (u_0)_{x_2}, -(u_0)_{x_1}]
                           // (u_0)_{x_2} * (op * curl)_1 - (u_0)_{x_1} * (op * curl)_2
                           const fptype wx = sBo[dx][qx];
      ...
      for (int qz = 0; qz < Q1D; ++qz)
      {
         for (int qy = 0; qy < Q1D; ++qy)
         {
            for (int qx = 0; qx < Q1D; ++qx)
            {
               ...
               {
                  const fptype O21 = op(1,qx,qy,qz,e);
                  const fptype O31 = op(2,qx,qy,qz,e);
                  const fptype O12 = op(3,qx,qy,qz,e);
                  const fptype O22 = op(4,qx,qy,qz,e);
                  const fptype O32 = op(5,qx,qy,qz,e);
                  const fptype O13 = op(6,qx,qy,qz,e);
                  const fptype O23 = op(7,qx,qy,qz,e);
                  const fptype O33 = op(8,qx,qy,qz,e);
                  const fptype curlX = curl[qz][qy][qx][0];
                  const fptype curlY = curl[qz][qy][qx][1];
                  const fptype curlZ = curl[qz][qy][qx][2];
                                 ...
                                 Vector &y)
{
   ...
   auto device_kernel = [=] MFEM_DEVICE (int e)
   {
      ...
      fptype opc[maxCoeffDim];
      MFEM_SHARED fptype sop[maxCoeffDim][MQ1D][MQ1D];
      MFEM_SHARED fptype curl[MQ1D][MQ1D][3];
               ...
               MFEM_FOREACH_THREAD(dx,x,D1D)
               {
                  for (int qy = 0; qy < Q1D; ++qy)
                  {
                     ...
                     for (int qx = 0; qx < Q1D; ++qx)
                     {
                        ...
                        {
                           const fptype O21 = sop[1][qx][qy];
                           const fptype O31 = sop[2][qx][qy];
                           const fptype O12 = sop[3][qx][qy];
                           const fptype O22 = sop[4][qx][qy];
                           const fptype O32 = sop[5][qx][qy];
                           const fptype O13 = sop[6][qx][qy];
                           const fptype O23 = sop[7][qx][qy];
                           const fptype O33 = sop[8][qx][qy];
                                      ...
                                      Vector &y)
{
   ...
   mfem::forall(NE, [=] MFEM_HOST_DEVICE (int e)
   {
      ...
      fptype mass[MQ1D][MQ1D][MQ1D][VDIM];
      ...
      for (int qz = 0; qz < Q1D; ++qz)
      {
         for (int qy = 0; qy < Q1D; ++qy)
         {
            for (int qx = 0; qx < Q1D; ++qx)
            {
               ...
               {
                  const fptype O12 = op(1,qx,qy,qz,e);
                  const fptype O13 = op(2,qx,qy,qz,e);
                  const fptype O21 = op(3,qx,qy,qz,e);
                  const fptype O22 = op(4,qx,qy,qz,e);
                  const fptype O23 = op(5,qx,qy,qz,e);
                  const fptype O31 = op(6,qx,qy,qz,e);
                  const fptype O32 = op(7,qx,qy,qz,e);
                  const fptype O33 = op(8,qx,qy,qz,e);
            ...
            if (tidz == qz)
            {
               ...
               MFEM_FOREACH_THREAD(qy,y,Q1D)
               {
                  MFEM_FOREACH_THREAD(qx,x,Q1D)
                  {
                     ...
                     for (int dz = 0; dz < D1Dz; ++dz)
                     {
                        const fptype wz = (c == 2) ? sBo[dz][qz] : sBc[dz][qz];

                        for (int dy = 0; dy < D1Dy; ++dy)
                        {
                           const fptype wy = (c == 1) ? sBo[dy][qy] : sBc[dy][qy];

                           for (int dx = 0; dx < D1Dx; ++dx)
                           {
                              const fptype wx = sX[dz][dy][dx] * ((c == 0) ? sBo[dx][qx] : sBc[dx][qx]);
                              u += wx * wy * wz;
                           }
                        }
                     }
                  ...
                  for (int qy = 0; qy < Q1D; ++qy)
                  {
                     ...
                     for (int qx = 0; qx < Q1D; ++qx)
                     {
                        ...
                        else
                        {
                           const fptype O12 = sop[1][qx][qy];
                           const fptype O13 = sop[2][qx][qy];
                           const fptype O21 = sop[3][qx][qy];
                           const fptype O22 = sop[4][qx][qy];
                           const fptype O23 = sop[5][qx][qy];
                           const fptype O31 = sop[6][qx][qy];
                           const fptype O32 = sop[7][qx][qy];
                           const fptype O33 = sop[8][qx][qy];
