...
protected:
   ...
   void SetupMultInputs(const Operator *elem_restrict_x,
                        ...
                        Vector &y, Vector &localY, const fptype c) const;
...
public:
   ...
   */
   ...
   void Mult(const Vector &x, Vector &y) const;
   /// y += c*A*x
   void AddMult(const Vector &x, Vector &y, const fptype c=1.0) const;
   /// y = A^T*x
   void MultTranspose(const Vector &x, Vector &y) const;
   /// y += c*A^T*x
   void AddMultTranspose(const Vector &x, Vector &y, const fptype c=1.0) const;
