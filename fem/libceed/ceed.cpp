...
//    CeedVectorCreate(ceed, nelem * nqpts * qdatasize, &ceedData.qdata);
...
//    CeedOperatorApply(ceedData.build_oper, ceedData.node_coords, ceedData.qdata,
...
//                         CEED_BASIS_COLLOCATED, ceedData.qdata);
//    // output
//    switch (op.test_op)
//    {
//       case EvalMode::None:
...
// void CeedAddMult(const CeedOperator oper,
//                  const Vector &x, const CeedVector &u,
//                  Vector &y, const CeedVector &v)
// {
...
// {
// #ifdef MFEM_USE_CEED
//    CeedAddMult(ceedDataPtr->oper, x, ceedDataPtr->u, y, ceedDataPtr->v);
// #else
//    mfem_error("MFEM must be built with MFEM_USE_CEED=YES to use libCEED.");
// #endif
// }

// void CeedAssembleDiagonal(const CeedOperator oper, const CeedVector v,
//                           Vector &diag)
// {
//    CeedScalar *d_ptr;
//    CeedMemType mem;
...
// {
// #ifdef MFEM_USE_CEED
//    CeedAssembleDiagonal(ceedDataPtr->oper, ceedDataPtr->v, diag);
// #else
//    mfem_error("MFEM must be built with MFEM_USE_CEED=YES to use libCEED.");
// #endif
// }
