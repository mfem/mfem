...
{
/*
   std::cout << "PABilinearFormExtension::Mult x " << std::endl;
   x.Print(std::cout,1);
   std::cout << "end PABilinearFormExtension::Mult x " << std::endl;
*/
   ...
   std::chrono::time_point<std::chrono::system_clock> totalstart = std::chrono::system_clock::now();
...
/*
   std::cout << "PABilinearFormExtension::Mult before normd y " << std::endl;
   //y.Print(std::cout,1);
   std::cout << "end PABilinearFormExtension::Mult before normd y " << std::endl;
*/
...
timelines[tid] = __LINE__;
   timings[tid++] = std::chrono::system_clock::now();
         ...
         //std::cout << "% done with int work " << std::endl;
         //exit(1);
      }
   }
...
timelines[tid] = __LINE__;
   ...
   std::chrono::time_point<std::chrono::system_clock> totalend = std::chrono::system_clock::now();
   auto time2 = std::chrono::duration_cast<std::chrono::microseconds>(totalend-totalstart).count();
   std::cout << "%  total " << time2;
   std::cout << std::endl;

   std::cout << "% " << __LINE__ << " in " << __FUNCTION__ << " in " << __FILE__ << std::endl;


   std::cout << "PABilinearFormExtension::Mult final y " << std::endl;
   y.Print(std::cout,1);
   std::cout << "end PABilinearFormExtension::Mult final y " << std::endl;
