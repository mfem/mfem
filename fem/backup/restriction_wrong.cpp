...
//            }
      ...
      std::cout << "% " << __LINE__ << " in " << __FUNCTION__ << " in " << __FILE__ << std::endl;
            ...
            const int lid2 = GetLid(p, 0, dof1d, dof, f_ind, facemapnorother);
            const int gid2 = GetGid(p, 0, dof1d, e2, elem_dofs, facemapnorother, elementMap);
      std::cout << "% " << __LINE__ << " in " << __FUNCTION__ << " in " << __FILE__ << std::endl;
...
std::cout << "% " << __LINE__ << " in " << __FUNCTION__ << " in " << __FILE__ << std::endl;
               ...
               int gid = GetGid(d, k, dof1d, e1, elem_dofs, facemapnorself, elementMap);
               int lid = GetLid(d, k, dof1d, dof1d*dof, f_ind, facemaptan1self);
               /*
               int gid = elementMap[e1*elem_dofs + did];
               //std::cout << "gid = " << gid << std::endl;
