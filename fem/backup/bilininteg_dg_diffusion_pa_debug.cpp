...
*/
               ...
               std::cout << " op1 " << op1(p,0,0,f_ind) << " " <<  op1(p,0,1,f_ind)
                         << " op1 " << op1(p,1,0,f_ind) << " " <<  op1(p,1,1,f_ind)
                         << " op2 " << op2(p,0,f_ind) << " " <<  op2(p,1,f_ind)
                         << " op3 " << op3(p,0,f_ind) << " " <<  op3(p,1,f_ind) 
                         << std::endl;
            }
         }
         f_ind++;
      ...
      for (int q1 = 0; q1 < Q1D; ++q1)
      {
         for (int q2 = 0; q2 < Q1D; ++q2)
         {
            for (int c = 0; c < VDIM; c++)
            {
              ...
              std::cout << "%" << f << " " << q1 << " " << q2 << " d0 " << D0[q1][q2][0] << " dj0 " << D0jumpu[q1][q2][0] << " d1 " << D1[q1][q2][0] << " dj1 " << D1jumpu[q1][q2][0]  << std::endl;
