                                     ...
                                     Array<int>* slave_boundary)
{
   Array<int> orders(1);
   orders[0] = order;
   return NURBSConstructor(mesh, &orders, vdim, ordering, master_boundary,
                           slave_boundary);
}
