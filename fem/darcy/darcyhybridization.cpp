...
void DarcyHybridization::ComputeH(std::unique_ptr<SparseMatrix> &H) const
{
...
#ifdef MFEM_USE_MPI
void DarcyHybridization::ComputeParH(std::unique_ptr<SparseMatrix> &H,
   ...
   GridFunction &ut) const
{
   ...
   DenseMatrix Ct, Ct1, Ct2, Mf, fmat1, fmat2;
