...
void TransposeIntegrator::AssembleEA(const FiniteElementSpace &fes, Vector &ea_data)
{
                                                  ...
                                                  Vector &ea_data_ext)
{
  ...
  const int faceDofs = fes.GetTraceElement(0, fes.GetMesh()->GetFaceBaseGeometry(0))->GetDof();
