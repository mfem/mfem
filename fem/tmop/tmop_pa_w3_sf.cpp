...
MFEM_REGISTER_TMOP_KERNELS(double, EnergyPA_SF_3D,
...
double TMOP_Integrator::GetLocalStateEnergyPA_SF_3D(const Vector &X) const
{
   const int N = PA.ne;
   ...
   MFEM_LAUNCH_TMOP_KERNEL(EnergyPA_SF_3D,id,sn,SFG,SFM,C0SF,N,O,E);
}
