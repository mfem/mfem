...
void TMOP_TcIdealShapeUnitSize_2D(const int NE, const ConstDeviceMatrix &W,
                                  DeviceTensor<5> &J, const int q1d) {
  constexpr int NBZ = 1;
...
void TMOP_TcIdealShapeGivenSize_2D(const int NE, const double detW,
                                   const ConstDeviceMatrix &B,
                                   const ConstDeviceMatrix &G,
                                   const ConstDeviceMatrix &W,
                                   const DeviceTensor<4, const double> &X,
                                   DeviceTensor<5> &J, const int d1d,
...
bool TargetConstructor::ComputeAllElementTargets<2>(
  ...
  switch (target_type) {
    case IDEAL_SHAPE_UNIT_SIZE:  // Jtr(i) = Wideal;
    {
      ...
      if (q == 2) {
        ker = TMOP_TcIdealShapeUnitSize_2D<2>;
      }
      if (q == 3) {
        ker = TMOP_TcIdealShapeUnitSize_2D<3>;
      }
      if (q == 4) {
        ker = TMOP_TcIdealShapeUnitSize_2D<4>;
      }
      if (q == 5) {
        ker = TMOP_TcIdealShapeUnitSize_2D<5>;
      }
      if (q == 6) {
        ker = TMOP_TcIdealShapeUnitSize_2D<6>;
      }
    ...
    case IDEAL_SHAPE_GIVEN_SIZE: {
      ...
      if (d == 2 && q == 2) {
        ker = TMOP_TcIdealShapeGivenSize_2D<2, 2>;
      }
      if (d == 2 && q == 3) {
        ker = TMOP_TcIdealShapeGivenSize_2D<2, 3>;
      }
      if (d == 2 && q == 4) {
        ker = TMOP_TcIdealShapeGivenSize_2D<2, 4>;
      }
      if (d == 2 && q == 5) {
        ker = TMOP_TcIdealShapeGivenSize_2D<2, 5>;
      }
      if (d == 2 && q == 6) {
        ker = TMOP_TcIdealShapeGivenSize_2D<2, 6>;
      }

      if (d == 3 && q == 3) {
        ker = TMOP_TcIdealShapeGivenSize_2D<3, 3>;
      }
      if (d == 3 && q == 4) {
        ker = TMOP_TcIdealShapeGivenSize_2D<3, 4>;
      }
      if (d == 3 && q == 5) {
        ker = TMOP_TcIdealShapeGivenSize_2D<3, 5>;
      }
      if (d == 3 && q == 6) {
        ker = TMOP_TcIdealShapeGivenSize_2D<3, 6>;
      }

      if (d == 4 && q == 4) {
        ker = TMOP_TcIdealShapeGivenSize_2D<4, 4>;
      }
      if (d == 4 && q == 5) {
        ker = TMOP_TcIdealShapeGivenSize_2D<4, 5>;
      }
      if (d == 4 && q == 6) {
        ker = TMOP_TcIdealShapeGivenSize_2D<4, 6>;
      }

      if (d == 5 && q == 5) {
        ker = TMOP_TcIdealShapeGivenSize_2D<5, 5>;
      }
      if (d == 5 && q == 6) {
        ker = TMOP_TcIdealShapeGivenSize_2D<5, 6>;
      }
