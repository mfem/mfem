                           ...
                           const int q1d)
{
   ...
   MFEM_FORALL_3D(e, NE, Q1D, Q1D, Q1D,
   {
      ...
      kernels::internal::load::Data<MD1>(e,D1D,X,s_DDD);
      kernels::internal::load::BG<MD1,MQ1>(D1D,Q1D,b,g,s_BG);

      kernels::internal::grad::X<MD1,MQ1>(D1D,Q1D,s_BG,s_DDD,s_DDQ);
      kernels::internal::grad::Y<MD1,MQ1>(D1D,Q1D,s_BG,s_DDQ,s_DQQ);
      kernels::internal::grad::Z<MD1,MQ1>(D1D,Q1D,s_BG,s_DQQ,s_QQQ);
      ...
      MFEM_FOREACH_THREAD(qz,z,Q1D)
      {
         MFEM_FOREACH_THREAD(qy,y,Q1D)
         {
            MFEM_FOREACH_THREAD(qx,x,Q1D)
            {
               ...
               // Jpr = X^T.DSh
               double Jpr[9];
               kernels::internal::pull::Grad<MQ1>(Q1D,qx,qy,qz,s_QQQ,Jpr);
               ...
               kernels::internal::push::Grad<MQ1>(Q1D,qx,qy,qz,A,s_QQQ);
            }
         }
      }
      MFEM_SYNC_THREAD;
      kernels::internal::load::BGt<MD1,MQ1>(D1D,Q1D,b,g,s_BG);
      kernels::internal::grad::Zt<MD1,MQ1>(D1D,Q1D,s_BG,s_QQQ,s_DQQ);
      kernels::internal::grad::Yt<MD1,MQ1>(D1D,Q1D,s_BG,s_DQQ,s_DDQ);
      kernels::internal::grad::Xt<MD1,MQ1>(D1D,Q1D,s_BG,s_DDQ,Y,e);
   });
}
