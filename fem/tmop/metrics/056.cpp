...
template <>
void TMOPKernel<56>(setup_t &ker)
{
   const static auto setup_kernels = [] { return TMOPAdd<S056>(); }();
...
template <>
void TMOPKernel<56>(mult_t &ker)
{
   const static auto mult_kernels = [] { return TMOPAdd<K056>(); }();
