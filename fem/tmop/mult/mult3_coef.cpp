      ...
      MFEM_FOREACH_THREAD(qz, z, Q1D)
      {
         MFEM_FOREACH_THREAD(qy, y, Q1D)
         {
            MFEM_FOREACH_THREAD(qx, x, Q1D)
            {
               ...
               kernels::internal::PushEval<MQ1>(Q1D, qx, qy, qz, d1, s00);
            }
         }
      }
      MFEM_SYNC_THREAD;
      kernels::internal::LoadBt<MD1, MQ1>(D1D, Q1D, b, B);
      kernels::internal::EvalXt<MD1, MQ1>(D1D, Q1D, B, s00, s01);
      kernels::internal::EvalYt<MD1, MQ1>(D1D, Q1D, B, s01, s00);
      kernels::internal::EvalZt<MD1, MQ1>(D1D, Q1D, B, s00, Y, e);
   });
}
