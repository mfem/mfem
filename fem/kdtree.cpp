...
template<>
void KDTreeNodalProjection<2>::Project(const GridFunction& gf, fptype lerr)
{
...
template<>
void KDTreeNodalProjection<3>::Project(const GridFunction& gf, fptype lerr)
{
   int ordering = gf.FESpace()->GetOrdering();
