                                           ...
                                           int skip_zeros)
{
   ...
   for(int i=0; i< pfes1->GetNE(); i++)
   {
      ...
      for(int edge1=0; edge1<no_faces; edge1++)
      {
         ...
         {
            HDGBilinearForm2::compute_face_integrals(i, fcs[edge1], Edge_to_Be[fcs[edge1]], false,
...
void ParHDGBilinearForm2::Update(FiniteElementSpace *nfes1, FiniteElementSpace *nfes2)
{
