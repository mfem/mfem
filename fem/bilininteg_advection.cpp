                             ...
                             Vector &y)
{
   if (dim == 2)
   {
      switch ((D1D << 4 ) | Q1D)
      {
         case 0x22: return PAAdvectionApply2D<2,2,16>(NE,B,G,Bt,Gt,op,x,y);
         case 0x33: return PAAdvectionApply2D<3,3,16>(NE,B,G,Bt,Gt,op,x,y);
         case 0x44: return PAAdvectionApply2D<4,4,8>(NE,B,G,Bt,Gt,op,x,y);
         case 0x55: return PAAdvectionApply2D<5,5,8>(NE,B,G,Bt,Gt,op,x,y);
         case 0x66: return PAAdvectionApply2D<6,6,4>(NE,B,G,Bt,Gt,op,x,y);
         case 0x77: return PAAdvectionApply2D<7,7,4>(NE,B,G,Bt,Gt,op,x,y);
         case 0x88: return PAAdvectionApply2D<8,8,2>(NE,B,G,Bt,Gt,op,x,y);
         case 0x99: return PAAdvectionApply2D<9,9,2>(NE,B,G,Bt,Gt,op,x,y);
   ...
   else if (dim == 3)
   {
      switch ((D1D << 4 ) | Q1D)
      {
         case 0x23: return PAAdvectionApply3D<2,3>(NE,B,G,Bt,Gt,op,x,y);
         case 0x34: return PAAdvectionApply3D<3,4>(NE,B,G,Bt,Gt,op,x,y);
         case 0x45: return PAAdvectionApply3D<4,5>(NE,B,G,Bt,Gt,op,x,y);
         case 0x56: return PAAdvectionApply3D<5,6>(NE,B,G,Bt,Gt,op,x,y);
         case 0x67: return PAAdvectionApply3D<6,7>(NE,B,G,Bt,Gt,op,x,y);
         case 0x78: return PAAdvectionApply3D<7,8>(NE,B,G,Bt,Gt,op,x,y);
         case 0x89: return PAAdvectionApply3D<8,9>(NE,B,G,Bt,Gt,op,x,y);
