                             ...
                             Vector &y)
{
   if (dim == 2)
   {
      switch ((D1D << 4 ) | Q1D)
      {
         case 0x22: return PAConvectionApply2D<2,2,16>(NE,B,G,Bt,Gt,op,x,y);
         case 0x33: return PAConvectionApply2D<3,3,16>(NE,B,G,Bt,Gt,op,x,y);
         case 0x44: return PAConvectionApply2D<4,4,8>(NE,B,G,Bt,Gt,op,x,y);
         case 0x55: return PAConvectionApply2D<5,5,8>(NE,B,G,Bt,Gt,op,x,y);
         case 0x66: return PAConvectionApply2D<6,6,4>(NE,B,G,Bt,Gt,op,x,y);
         case 0x77: return PAConvectionApply2D<7,7,4>(NE,B,G,Bt,Gt,op,x,y);
         case 0x88: return PAConvectionApply2D<8,8,2>(NE,B,G,Bt,Gt,op,x,y);
         case 0x99: return PAConvectionApply2D<9,9,2>(NE,B,G,Bt,Gt,op,x,y);
