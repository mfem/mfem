...
#define NODAL_INTERP_3D_INSTANCE(Q1D) \
template void NodalInterpolation3D<2,Q1D>\
    (const int, const Vector&, Vector&,const Array<double>&)

NODAL_INTERP_3D_INSTANCE(2);
NODAL_INTERP_3D_INSTANCE(3);
NODAL_INTERP_3D_INSTANCE(4);
NODAL_INTERP_3D_INSTANCE(5);
NODAL_INTERP_3D_INSTANCE(6);
NODAL_INTERP_3D_INSTANCE(7);/*
NODAL_INTERP_3D_INSTANCE(8);
NODAL_INTERP_3D_INSTANCE(9);
NODAL_INTERP_3D_INSTANCE(10);
NODAL_INTERP_3D_INSTANCE(11);
NODAL_INTERP_3D_INSTANCE(12);
NODAL_INTERP_3D_INSTANCE(13);
NODAL_INTERP_3D_INSTANCE(14);
NODAL_INTERP_3D_INSTANCE(15);
NODAL_INTERP_3D_INSTANCE(16);
NODAL_INTERP_3D_INSTANCE(17);*/
