...
public:
   ...
   virtual fptype GetTotalError() const { return 0.0; }
...
public:
   ...
   /// Return the total error from the last error estimate.
   virtual fptype GetTotalError() const override { return total_error; }
...
public:
   ...
   */
   ...
   void SetTichonovRegularization(fptype tcoeff = 1.0e-8)
   {
...
public:
   ...
   using ElementCoefficientFunction =
      std::function<fptype(Mesh*, const int)>;
   ...
   using FaceCoefficientFunction =
      std::function<fptype(Mesh*, const int, const bool)>;
