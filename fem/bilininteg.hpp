...
protected:
   ...
   { return std::max(space_dim, test_fe.GetInterpDim()); }
   ...
   { return std::max(space_dim, trial_fe.GetInterpDim()); }
...
protected:
   ...
   { return std::max(space_dim, vector_fe.GetInterpDim()); }
...
public:
   ...
   inline virtual bool VerifyFiniteElementTypes(
      ...
      const FiniteElement & test_fe) const
   {
      return (trial_fe.GetInterpDim() == 3 &&
              trial_fe.GetRangeType() == mfem::FiniteElement::VECTOR &&
              test_fe.GetRangeType()  == mfem::FiniteElement::SCALAR &&
              test_fe.GetDerivType()  == mfem::FiniteElement::GRAD );
   }
...
public:
   ...
   inline virtual bool VerifyFiniteElementTypes(
      ...
      const FiniteElement & test_fe) const
   {
      return (trial_fe.GetCurlDim() == 3 && trial_fe.GetInterpDim() == 3 &&
              test_fe.GetCurlDim() == 3 && test_fe.GetInterpDim() == 3 &&
              trial_fe.GetRangeType() == mfem::FiniteElement::VECTOR &&
              trial_fe.GetDerivType() == mfem::FiniteElement::CURL &&
              test_fe.GetRangeType()  == mfem::FiniteElement::VECTOR &&
              test_fe.GetDerivType()  == mfem::FiniteElement::CURL );
...
public:
   ...
   inline virtual bool VerifyFiniteElementTypes(
      ...
      const FiniteElement & test_fe) const
   {
      return (trial_fe.GetInterpDim() == 3 && test_fe.GetCurlDim() == 3 &&
              trial_fe.GetRangeType() == mfem::FiniteElement::VECTOR &&
              test_fe.GetRangeType()  == mfem::FiniteElement::VECTOR &&
              test_fe.GetDerivType()  == mfem::FiniteElement::CURL );
   }
...
public:
   ...
   inline virtual bool VerifyFiniteElementTypes(
      ...
      const FiniteElement & test_fe) const
   {
      return (trial_fe.GetCurlDim() == 3 && test_fe.GetInterpDim() == 3 &&
              trial_fe.GetRangeType() == mfem::FiniteElement::VECTOR &&
              trial_fe.GetDerivType() == mfem::FiniteElement::CURL   &&
              test_fe.GetRangeType()  == mfem::FiniteElement::VECTOR );
   }
