...
/// Nedelec ShapeEvaluator without tensor-product structure
template <class FE, class IR, typename real_t>
...
public:
             ...
             const D2_layout_t &D2_layout,const D2_data_t &D2_data) const
   {
      ...
      OffsetStridedLayout3D<dof0,1,dof1,dof0,NC,dof0*dof1> dof_layout1(
         D1*dof0*dof1*NC);
                      ...
                      const D22_layout_t &D22_layout,const D22_data_t &D22_data) const
   {
      ...
      OffsetStridedLayout4D<dof00,1,dof01,dof00,dof10,2*dof00*dof01,dof11*NC,2*dof00*dof01*dof10>
      M1_layout(D1*2*dof00*dof01*dof10*dof11+D2*dof00*dof01);
...
public:
                  ...
                  const D3_layout_t &D3_layout,const D3_data_t &D3_data) const
   {
      ...
      OffsetStridedLayout3D<dof0,1,dof1*dof2,dof0,NC,dof0*dof1*dof2> dof_layout1(
         D1*dof0*dof1*dof2*NC);
      // QDD_{i,jj,k} = \sum_s B_1d_{i,s} dof_data_{s,jj,k}
      Mult_2_1<false>(D1_layout, D1_data,
                      dof_layout1, dof_data,
                   ...
                   const D3_layout_t &D3_layout,const D3_data_t &D3_data) const
   {
      ...
      TVector<NIP*dof1*dof2*NC> QDD;
      TVector<NIP*NIP*dof2*NC> QQD;
      OffsetStridedLayout3D<dof0,1,dof1*dof2,dof0,NC,dof1*dof2*dof0> dof_layout1(
         D1*dof1*dof2*dof0*NC);
      // qpt_data_{ii,j,k} = \sum_s B_1d_{j,s} QQD_{ii,s,k}
                      ...
                      const D23_layout_t &D23_layout,const D23_data_t &D23_data) const
   {
      ...
      OffsetStridedLayout4D<dof00,1,dof01*dof02,dof00,dof10,3*dof00*dof01*dof02*NC,dof11*dof12*NC,3*dof10*dof00*dof01*dof02>
      M1_layout(D1*(dof00*dof01*dof02*NC)*3*dof10*dof11*dof12*NC
                +D2*dof10*dof11*dof12*NC);
      // Using TensorAssemble: <I,NIP,J> --> <DOF,I,DOF,J>
