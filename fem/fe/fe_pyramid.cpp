...
{
   return Vector({(z < 1.0) ? - (1.0 - y - z) / (1.0 - z) : 0.0,
                  (z < 1.0) ? - (1.0 - x - z) / (1.0 - z) : 0.0,
                  (z < 1.0) ? x * y / ((1.0 - z) * (1.0 - z)) - 1.0 : 0.0});
}
