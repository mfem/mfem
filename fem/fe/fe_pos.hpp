...
public:
   ...
   static void CalcShape(const int p, const fptype x, const fptype y,
                         fptype *shape);

   // The size of dshape_1d is p+1; the size of dshape is (dof x dim).
   static void CalcDShape(const int p, const fptype x, const fptype y,
                          fptype *dshape_1d, fptype *dshape);
...
public:
   ...
   static void CalcShape(const int p, const fptype x, const fptype y,
                         const fptype z, fptype *shape);

   // The size of dshape_1d is p+1; the size of dshape is (dof x dim).
   static void CalcDShape(const int p, const fptype x, const fptype y,
                          const fptype z, fptype *dshape_1d, fptype *dshape);
