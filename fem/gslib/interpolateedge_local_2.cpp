...
static void InterpolateEdgeLocal2D_Kernel(const double *const gf_in,
                                          int *const el,
                                          double *const r,
...
void FindPointsGSLIB::InterpolateEdgeLocal2(const Vector &field_in,
                                            ...
                                            int nel, int dof1Dsol)
{
   ...
   MFEM_VERIFY(dim==1 && spacedim==2,"Kernel for 2D edges only.");
   InterpolateEdgeLocal2D_Kernel(field_in.Read(),
