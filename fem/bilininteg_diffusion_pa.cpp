                           ...
                           Vector &d)
{
   ...
   const auto J = Reshape(j, Q1D,Q1D,2,2,NE);
   const auto C = const_c ? Reshape(c, 1,1,1) :
                  Reshape(c, Q1D,Q1D,NE);
                           ...
                           Vector &d)
{
   ...
   const bool const_c = c.Size() == 1;
   const auto W = Reshape(w, Q1D,Q1D);
   const auto J = Reshape(j, Q1D,Q1D,SDIM,DIM,NE);
   const auto C = const_c ? Reshape(c, 1,1,1) :
                  Reshape(c, Q1D,Q1D,NE);
   auto D = Reshape(d.Write(), Q1D,Q1D, 3, NE);
   MFEM_FORALL_2D(e, NE, Q1D,Q1D,1,
                               ...
                               Vector &d)
{
   ...
   const auto J = Reshape(j, Q1D,Q1D,Q1D,3,3,NE);
   const auto C = const_c ? Reshape(c, 1,1,1,1) :
                  Reshape(c, Q1D,Q1D,Q1D,NE);
