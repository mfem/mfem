...
template<int T_D1D = 0, int T_Q1D = 0>
static void EAConvectionAssemble3D0D(const int NE,
                                     const Array<double> &b,
                                     const Array<double> &g,
                                     const Vector &padata,
                                     Vector &eadata,
...
template<int T_D1D = 0, int T_Q1D = 0>
static void EAConvectionAssemble3D1D(const int NE,
                                     const Array<double> &b,
                                     const Array<double> &g,
                                     const Vector &padata,
                                     Vector &eadata,
...
template<int T_D1D = 0, int T_Q1D = 0>
static void EAConvectionAssemble3D2D(const int NE,
                                     const Array<double> &b,
                                     const Array<double> &g,
                                     const Vector &padata,
                                     Vector &eadata,
...
template<int T_D1D = 0, int T_Q1D = 0>
static void EAConvectionAssemble3D3D(const int NE,
                                     const Array<double> &b,
                                     const Array<double> &g,
                                     const Vector &padata,
                                     Vector &eadata,
                                         ...
                                         Vector &ea_data)
{
   ...
   else if (dim == 3)
   {
      switch ((dofs1D << 4 ) | quad1D)
      {
         case 0x23: return EAConvectionAssemble3D0D<2,3>(ne,B,G,pa_data,ea_data);
         case 0x34: return EAConvectionAssemble3D0D<3,4>(ne,B,G,pa_data,ea_data);
         case 0x45: return EAConvectionAssemble3D0D<4,5>(ne,B,G,pa_data,ea_data);
         case 0x56: return EAConvectionAssemble3D0D<5,6>(ne,B,G,pa_data,ea_data);
         case 0x67: return EAConvectionAssemble3D0D<6,7>(ne,B,G,pa_data,ea_data);
         case 0x78: return EAConvectionAssemble3D0D<7,8>(ne,B,G,pa_data,ea_data);
         case 0x89: return EAConvectionAssemble3D0D<8,9>(ne,B,G,pa_data,ea_data);
         default:   return EAConvectionAssemble3D0D(ne,B,G,pa_data,ea_data,dofs1D,quad1D);
      }
   }
