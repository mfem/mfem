...
IntegrationRule *IntegrationRules::WVTetrahedronIntegrationRule(int Order)
{
   ...
   switch (Order)
   {
      ...
      case 14:
         ir = new IntegrationRule(172);
         ir->AddTetPoints4(0, 1.60907140705744411413e-02, 7.54946394145864429701e-05);
         ir->AddTetPoints4(4, 5.33978316872111835600e-02, 4.99369162630264123125e-04);
         ir->AddTetPoints4(8, 1.19241746177145779839e-01, 6.75518136484315554618e-03);
         ir->AddTetPoints4(12, 1.30867341458183572556e-01, -9.36983580827872170049e-03);
         ir->AddTetPoints4(16, 1.50480701683380624356e-01, 6.41689100004805106081e-03);
         ir->AddTetPoints4(20, 2.99053953971220476404e-01, 1.64101626885896967334e-01);
         ir->AddTetPoints4(24, 3.01455727121437755400e-01, -4.66601378582287062979e-01);
         ir->AddTetPoints12(28, 7.88324467290540953357e-03, 7.39625180215418231988e-01,
                            1.25843295012901661709e-04);
         ir->AddTetPoints12(40, 1.45390592127980777803e-02, 8.77073833608856046062e-01,
                            1.69974392210926370742e-04);
         ir->AddTetPoints12(52, 2.29881524354522692732e-02, 5.54939668187987455994e-01,
                            5.38677484719800206241e-04);
         ir->AddTetPoints12(64, 4.34967365351852652822e-02, 7.29215040191393826241e-01,
                            8.46950775905798013306e-04);
         ir->AddTetPoints12(76, 9.04435046404261644426e-02, 5.12656682776023497894e-01,
                            2.18718419020480069753e-03);
         ir->AddTetPoints12(88, 1.06654599417702888875e-01, 7.83705049915160323337e-01,
                            3.22270419821161385222e-04);
         ir->AddTetPoints12(100, 1.81664385290099705816e-01, 5.97495806956145014688e-01,
                            1.61114781938893067773e-03);
         ir->AddTetPoints12(112, 2.65479463954486016863e-01, 4.60142857289173923263e-01,
                            8.17648725356031886961e-04);
         ir->AddTetPoints12(124, 3.10144666325451900946e-01, 2.87631866112052492213e-01,
                            1.04431326766746060408e-01);
         ir->AddTetPoints12(136, 4.25519841175517332665e-01, 1.28312058667753137176e-01,
                            1.20437150294995325671e-03);
         ir->AddTetPoints24(148, 6.18529539165787345389e-01, 2.82330842522221292512e-01,
                            9.07062156266963959261e-02, 5.03855314575061305309e-04);
         ir->SetOrder(14);
      ...
      case 16:
         ir = new IntegrationRule(251);
         ir->AddTetMidPoint(0, 2.58959863547084849847e-03);
         ir->AddTetPoints4(1, 1.23747237099888218737e-02, 3.63964567528263520293e-05);
         ir->AddTetPoints4(5, 6.02012588573790363711e-02, 3.36509058800166477136e-04);
         ir->AddTetPoints4(9, 1.08043771991761183848e-01, 6.45429496421605092965e-04);
         ir->AddTetPoints4(13, 1.88914461484678386505e-01, 2.34421745130212891631e-03);
         ir->AddTetPoints4(17, 2.97797830588990897205e-01, 2.18006411752639378543e-03);
         ir->AddTetPoints4(21, 3.24830547950554882064e-01, 1.06229713844189165538e-03);
         ir->AddTetPoints4(25, 3.32449334330004009352e-01, 9.78073072290451631669e-05);
         ir->AddTetPoints6(29, 4.84248176085966430815e-01, 1.96869102359009738416e-04);
         ir->AddTetPoints6(35, 4.27535644731774300276e-01, 1.30134306586444773758e-03);
         ir->AddTetPoints6(41, 3.50634616051016090310e-01, 1.90007072708723114864e-03);
         ir->AddTetPoints12(47, 1.22935973058597713958e-02, 7.93922874447673176945e-01,
                            1.37164227096131508248e-04);
         ir->AddTetPoints12(59, 1.50996786278673189585e-02, 6.33213779541794807848e-01,
                            2.43192029693733405456e-04);
         ir->AddTetPoints12(71, 1.61308740142629414294e-02, 8.95085657165385129019e-01,
                            1.45756721645160381828e-04);
         ir->AddTetPoints12(83, 5.07588199500651482410e-02, 7.46344121337981669662e-01,
                            5.95709805803569091703e-04);
         ir->AddTetPoints12(95, 5.25603550892442261677e-02, 6.05408849758901301819e-01,
                            6.07646860271852332774e-04);
         ir->AddTetPoints12(107, 8.77089040200159097971e-02, 8.17858020692106668648e-01,
                            2.13829636890236365974e-04);
         ir->AddTetPoints12(119, 1.04388019151778532745e-01, 5.78041483311681147939e-01,
                            1.22557905587592852817e-03);
         ir->AddTetPoints12(131, 1.60347411833149378069e-01, 6.53757252702163338398e-01,
                            8.72873185872998012640e-04);
         ir->AddTetPoints12(143, 2.39457676949806852473e-01, 5.16312965987717364946e-01,
                            4.11160240503043899248e-04);
         ir->AddTetPoints12(155, 3.99881575129947597347e-01, 1.84600239533183885232e-01,
                            6.97984094794420594637e-04);
         ir->AddTetPoints12(167, 4.62084718127788063313e-01, 6.67604827078860374456e-02,
                            3.08349640384845545982e-04);
         ir->AddTetPoints24(179, 7.12529415621108164203e-01, 2.15702921546446102496e-01,
                            6.68657299025011142568e-02, 1.98487535364948728452e-04);
         ir->AddTetPoints24(203, 5.64196110926300398170e-01, 3.16013769323177595716e-01,
                            1.04783302610509665431e-01, 5.19240310481615592077e-04);
         ir->AddTetPoints24(227, 4.69120486434289718503e-01, 2.87454329244969164492e-01,
                            1.80355969845450658795e-01, 1.42250301113061995532e-03);
         ir->SetOrder(16);
         TetrahedronIntRules[16] = ir;
         return ir;

      case 17:
         ir = new IntegrationRule(290);
         ir->AddTetPoints4(0, 1.51834035943118061951e-02, 5.66066043936779342543e-05);
         ir->AddTetPoints4(4, 7.74647606414237688277e-02, 5.27688563182958066469e-04);
         ir->AddTetPoints4(8, 1.31502970150497389135e-01, 1.29581841165886065860e-03);
         ir->AddTetPoints4(12, 2.78035730768526279100e-01, 1.72925489010635142009e-03);
         ir->AddTetPoints4(16, 3.07279621465279650927e-01, 1.54045458408175748102e-03);
         ir->AddTetPoints6(20, 4.39484939103899074908e-01, 8.70422378054942205358e-04);
         ir->AddTetPoints12(26, 1.41645503165777064680e-03, 6.89890590630384492599e-01,
                            3.11000868603953652906e-05);
         ir->AddTetPoints12(38, 1.11652741352541440278e-02, 5.10159409042039935223e-01,
                            8.31236942461529535213e-05);
         ir->AddTetPoints12(50, 1.35379123049503835574e-02, 8.97005004200253974744e-01,
                            1.01213247728760703911e-04);
         ir->AddTetPoints12(62, 1.56461841654722544348e-02, 7.92848423022011306038e-01,
                            1.81824952963591772318e-04);
         ir->AddTetPoints12(74, 5.33587741041104401951e-02, 7.11909763750086188594e-01,
                            6.16460872806461534709e-04);
         ir->AddTetPoints12(86, 7.41697125469042428669e-02, 8.36150707744749976946e-01,
                            2.88107861711184678240e-04);
         ir->AddTetPoints12(98, 8.44839873408992914072e-02, 5.55100549429352496666e-01,
                            1.11950930827250699946e-03);
         ir->AddTetPoints12(110, 1.48674230188103440042e-01, 6.69425218103412822401e-01,
                            7.21919198254127101981e-04);
         ir->AddTetPoints12(122, 1.56217904817074648705e-01, 4.18019613729795236345e-01,
                            1.74768136694503041159e-03);
         ir->AddTetPoints12(134, 1.92644699719220435785e-01, 5.37171463253357739376e-01,
                            6.34073199364894248171e-04);
         ir->AddTetPoints12(146, 2.07424502029553092797e-01, 5.82883489994977632698e-01,
                            2.05610702141960599533e-04);
         ir->AddTetPoints12(158, 2.32326761887219124247e-01, 4.75009812974796274965e-01,
                            9.44360717560376017841e-04);
         ir->AddTetPoints12(170, 2.81092688249817479473e-01, 4.22974328617336581271e-01,
                            6.84602741701386156500e-04);
         ir->AddTetPoints12(182, 3.85776545450869035037e-01, 1.64637725204575313676e-01,
                            1.37210310394647984691e-03);
         ir->AddTetPoints12(194, 4.12368263137344537306e-01, 1.67077684668713755123e-01,
                            3.89460448340449782393e-04);
         ir->AddTetPoints12(206, 4.61147338781188964596e-01, 6.77037006140759900497e-02,
                            3.10098986041437761716e-04);
         ir->AddTetPoints24(218, 7.32487919091578620900e-01, 1.85738271226835283123e-01,
                            7.83469460381917004455e-02, 1.81311397884791655321e-04);
         ir->AddTetPoints24(242, 6.20887872094294412939e-01, 3.20855169323265743131e-01,
                            4.48749892476862366486e-02, 3.19293009295538684263e-04);
         ir->AddTetPoints24(266, 5.56257109423550555327e-01, 2.95397018467932870323e-01,
                            1.28559642386651240553e-01, 6.52305356070513077393e-04);
         ir->SetOrder(17);
         TetrahedronIntRules[17] = ir;
         return ir;

      case 18:
         ir = new IntegrationRule(352);
         ir->AddTetPoints4(0, 9.61686057885913214704e-03, 1.79900598510881143757e-05);
         ir->AddTetPoints4(4, 5.12936314351375433063e-02, 2.58549800120680276297e-04);
         ir->AddTetPoints4(8, 1.03388333892645123413e-01, 8.33563472488888022698e-04);
         ir->AddTetPoints4(12, 1.66644582705468946582e-01, 1.31427450045005708712e-03);
         ir->AddTetPoints4(16, 2.26416719412848799209e-01, 1.01338869608695808858e-03);
         ir->AddTetPoints4(20, 3.07965134196289458401e-01, 7.64425695768690708840e-04);
         ir->AddTetPoints4(24, 3.28216242650454459451e-01, 6.93528761594880698189e-04);
         ir->AddTetPoints6(28, 4.84796260886375451893e-01, 2.27650953003556146773e-04);
         ir->AddTetPoints6(34, 3.39089193642736153045e-01, 1.14844713969750478882e-03);
         ir->AddTetPoints12(40, 7.71850424165076987038e-03, 6.46764964905669148543e-01,
                            7.21916017024133721417e-05);
         ir->AddTetPoints12(52, 8.95234493356222849059e-03, 8.13633895931891615305e-01,
                            8.07285925245263414739e-05);
         ir->AddTetPoints12(64, 1.34610178760395937658e-02, 9.13757711875504918808e-01,
                            8.62741737632223516449e-05);
         ir->AddTetPoints12(76, 2.19215398553447848862e-02, 6.78482305161191234788e-01,
                            1.64261693721656066138e-04);
         ir->AddTetPoints12(88, 4.01197143400287559167e-02, 7.92584315065369526820e-01,
                            3.33163022746763980587e-04);
         ir->AddTetPoints12(100, 4.56172410806642281145e-02, 5.53890148717233077313e-01,
                            5.03309297126329035880e-04);
         ir->AddTetPoints12(112, 7.00977092016143998876e-02, 6.41377952742742785119e-01,
                            7.60047512843793713483e-04);
         ir->AddTetPoints12(124, 1.07807941776183913163e-01, 4.75034120695582484650e-01,
                            1.29315065616773848881e-03);
         ir->AddTetPoints12(136, 1.26010834074982813746e-01, 7.23805172208656033561e-01,
                            4.95383865795005090028e-04);
         ir->AddTetPoints12(148, 1.78406849774610076764e-01, 6.41824876262129584426e-01,
                            1.45793610781469446360e-04);
         ir->AddTetPoints12(160, 1.81455836795786140669e-01, 5.66841371561274121049e-01,
                            1.07650077828533481672e-03);
         ir->AddTetPoints12(172, 2.43943148476238824696e-01, 3.91923058997890594313e-01,
                            1.26057168101188473222e-03);
         ir->AddTetPoints12(184, 2.54703697828915220924e-01, 4.79556098377775019692e-01,
                            4.05363225196851565194e-04);
         ir->AddTetPoints12(196, 4.32011445330227783490e-01, 1.01878266043575638200e-01,
                            6.94881930251123151876e-04);
         ir->AddTetPoints24(208, 8.41896155651658206764e-01, 1.00002886433827153922e-01,
                            5.57829593907744891723e-02, 7.15999148909537573484e-05);
         ir->AddTetPoints24(232, 4.45856453915421502288e-01, 3.73305888525746087936e-01,
                            1.77388247957959377388e-01, 1.67612575725395289167e-04);
         ir->AddTetPoints24(256, 5.52786083164828800918e-01, 3.76087919669856107774e-01,
                            6.71576745479016135043e-02, 1.87836401295096093022e-04);
         ir->AddTetPoints24(280, 7.12435372757378337916e-01, 2.16940273989595922011e-01,
                            6.18209374867157435141e-02, 2.26779065088560170642e-04);
         ir->AddTetPoints24(304, 5.76142505215545108754e-01, 2.70315658624264987253e-01,
                            1.32471878214908411753e-01, 5.89756396375611243940e-04);
         ir->AddTetPoints24(328, 4.32543361307244411673e-01, 3.18942749969520433773e-01,
                            1.98546376218948661396e-01, 8.55071249207632719420e-04);
         ir->SetOrder(18);
         TetrahedronIntRules[18] = ir;
         return ir;

      case 19:
         ir = new IntegrationRule(411);
         ir->AddTetMidPoint(0, 1.30415705945430195761e-03);
         ir->AddTetPoints4(1, 2.56738434907906043492e-02, 1.22106648270469043569e-04);
         ir->AddTetPoints4(5, 1.49746573248696557279e-01, 9.91265172484290810542e-04);
         ir->AddTetPoints4(9, 2.02766201287268299502e-01, 1.33274090503687553042e-03);
         ir->AddTetPoints4(13, 2.87859084679152554820e-01, 1.57471883712409347657e-03);
         ir->AddTetPoints4(17, 3.18477392847708040691e-01, 7.96432373841702732561e-04);
         ir->AddTetPoints6(21, 4.95377262276330387891e-01, 3.89985440050675505504e-05);
         ir->AddTetPoints6(27, 4.71972238459079318496e-01, 3.19234567839392314667e-04);
         ir->AddTetPoints6(33, 4.22428448619549090637e-01, 7.78201422383228828307e-04);
         ir->AddTetPoints12(39, 2.77555756156289135106e-16, 9.65886517598637750481e-01,
                            7.99532489622517356586e-06);
         ir->AddTetPoints12(51, 8.51043544222140901923e-03, 8.27371409231941079554e-01,
                            5.59220032620901127095e-05);
         ir->AddTetPoints12(63, 9.25599008193100925013e-03, 6.98640672236047755028e-01,
                            7.62030790311156246792e-05);
         ir->AddTetPoints12(75, 2.81991602682765685195e-02, 7.32739318755908697334e-01,
                            1.75131482190127481247e-04);
         ir->AddTetPoints12(87, 4.04365062193867697005e-02, 5.95066300740447307049e-01,
                            4.74238973007204520256e-04);
         ir->AddTetPoints12(99, 4.23188083811363302544e-02, 8.12208146897898108918e-01,
                            3.18366431523132108455e-04);
         ir->AddTetPoints12(111, 1.10113470488671039149e-01, 7.67019205814962856671e-01,
                            2.65210833258707628663e-04);
         ir->AddTetPoints12(123, 1.11100053311126156785e-01, 6.96967571426292731296e-01,
                            2.87870679472654376983e-04);
         ir->AddTetPoints12(135, 1.11113524032780963680e-01, 5.35819392807330485695e-01,
                            7.78782117142183647092e-04);
         ir->AddTetPoints12(147, 1.46347841721213289823e-01, 3.98267025083232084626e-01,
                            1.04717445208219340352e-03);
         ir->AddTetPoints12(159, 1.82597284062919029690e-01, 6.27330180991335639717e-01,
                            2.96330036006148993862e-04);
         ir->AddTetPoints12(171, 1.87542721721513760968e-01, 5.71797177432016412446e-01,
                            6.24697016845879738584e-04);
         ir->AddTetPoints12(183, 2.37582026621655062470e-01, 4.36727735043361930956e-01,
                            1.09072455791537552099e-03);
         ir->AddTetPoints12(195, 2.46280274642607710511e-01, 4.84624253405210259071e-01,
                            4.38265720448393833464e-04);
         ir->AddTetPoints12(207, 3.44378692084364446124e-01, 3.03026291709817874320e-01,
                            1.47004322634068689468e-04);
         ir->AddTetPoints12(219, 3.75592638945814738527e-01, 1.93367068746597314810e-01,
                            9.33888865482139312289e-04);
         ir->AddTetPoints12(231, 4.47029432154102512875e-01, 9.33876645072737598952e-02,
                            4.12303831488843746701e-04);
         ir->AddTetPoints24(243, 5.90201782319109025110e-01, 3.75360478225410743036e-01,
                            3.35039730859293394261e-02, 8.79128110970413457646e-05);
         ir->AddTetPoints24(267, 8.78105659745303412933e-01, 8.43196026635635309532e-02,
                            3.36062073054675947148e-02, 6.71998102919129313391e-05);
         ir->AddTetPoints24(291, 7.37124238418187416322e-01, 1.97910981867980062532e-01,
                            5.90399455174760445786e-02, 1.42906699225751101503e-04);
         ir->AddTetPoints24(315, 4.64856373493317098777e-01, 3.32415424637547474163e-01,
                            1.93993093993028276056e-01, 3.37463928275545980377e-04);
         ir->AddTetPoints24(339, 5.96937554195757447140e-01, 2.91080259003242747262e-01,
                            1.02226372688814237666e-01, 2.91003072529031139859e-04);
         ir->AddTetPoints24(363, 6.66765375637955237664e-01, 1.92814406710302366221e-01,
                            9.62911704754917940896e-02, 5.10526691093091903456e-04);
         ir->AddTetPoints24(387, 5.12429316555599534411e-01, 3.15113882716146820329e-01,
                            1.23547218644230016871e-01, 6.51050734761737912200e-04);
         ir->SetOrder(19);
         TetrahedronIntRules[19] = ir;
         return ir;

      case 20:
         ir = new IntegrationRule(474);
         ir->AddTetPoints4(0, 5.98838383403302865204e-02, 3.46952669421907969501e-04);
         ir->AddTetPoints4(4, 1.76319324173560554314e-01, 7.42504292736195586032e-04);
         ir->AddTetPoints4(8, 2.19869893679826899913e-01, 1.36484825068291398299e-03);
         ir->AddTetPoints6(12, 4.84821187514665963292e-01, 2.02379478885187860529e-04);
         ir->AddTetPoints6(18, 4.25806567054528073424e-01, 4.19200956273919260551e-04);
         ir->AddTetPoints6(24, 3.92889817627141424428e-01, 5.48713529392533434781e-04);
         ir->AddTetPoints12(30, 1.21829100393544553782e-03, 6.37484636302420915044e-01,
                            1.99367200097415833867e-05);
         ir->AddTetPoints12(42, 3.86481696256568696413e-03, 9.64164312000536316560e-01,
                            9.86865167491136159247e-06);
         ir->AddTetPoints12(54, 9.67889587577985821554e-03, 8.81489244440967878447e-01,
                            5.45258494005538708730e-05);
         ir->AddTetPoints12(66, 1.06145495399120326496e-02, 7.77393887251494941637e-01,
                            8.67281169175169552692e-05);
         ir->AddTetPoints12(78, 2.16747550651512632669e-02, 6.63922867293254448384e-01,
                            1.98569525446660088887e-04);
         ir->AddTetPoints12(90, 4.02435162838483129200e-02, 9.09758847526910052750e-01,
                            7.41431766873005578108e-05);
         ir->AddTetPoints12(102, 4.57023847898788693200e-02, 7.36571110321694311196e-01,
                            3.58530792791842073744e-04);
         ir->AddTetPoints12(114, 4.65643530376929071224e-02, 5.45039624684504286911e-01,
                            4.50818963507684247142e-04);
         ir->AddTetPoints12(126, 8.74740062600930512460e-02, 5.83015157736680667000e-01,
                            7.06802756592743615383e-04);
         ir->AddTetPoints12(138, 1.03416745757378247816e-01, 6.36008811731725853811e-01,
                            2.71599133822513969221e-04);
         ir->AddTetPoints12(150, 1.20168637310624271120e-01, 7.09201347540386106694e-01,
                            4.60263231044861392035e-04);
         ir->AddTetPoints12(162, 1.33035241114929203565e-01, 7.23887383206608170383e-01,
                            2.13081069442586882191e-04);
         ir->AddTetPoints12(174, 1.39393976698704902262e-01, 4.38743669082374110335e-01,
                            9.52359512323042991730e-04);
         ir->AddTetPoints12(186, 1.78295286807175323851e-01, 5.48146578245866766821e-01,
                            5.54359462979022452403e-04);
         ir->AddTetPoints12(198, 1.89964905224539459816e-01, 5.83861874350516285581e-01,
                            5.89607774477978949235e-04);
         ir->AddTetPoints12(210, 1.90117757480737392672e-01, 6.18173036107062312539e-01,
                            1.13692238098684928220e-04);
         ir->AddTetPoints12(222, 2.37844278314046309042e-01, 4.43721887411052506867e-01,
                            8.30843190337443994291e-04);
         ir->AddTetPoints12(234, 2.57952841115389963633e-01, 4.69617173267018128691e-01,
                            4.96967415685917396698e-04);
         ir->AddTetPoints12(246, 3.25177715062288874570e-01, 2.23715197127792919662e-01,
                            9.79967285073991530367e-04);
         ir->AddTetPoints12(258, 3.40103497404186827513e-01, 2.88282803499977591244e-01,
                            2.37566504060009967437e-04);
         ir->AddTetPoints12(270, 3.42442745768871570355e-01, 3.15114508462255860088e-01,
                            5.27820602733834493437e-05);
         ir->AddTetPoints12(282, 3.60749943264571548696e-01, 2.23172603780831479980e-01,
                            6.29139367397159050138e-04);
         ir->AddTetPoints12(294, 4.00142686932065783090e-01, 1.90313271215815593695e-01,
                            3.47697320346776451126e-04);
         ir->AddTetPoints24(306, 7.29559796580933839216e-01, 2.10233124136349092126e-01,
                            5.90079347937121911905e-02, 7.71913892762959581283e-05);
         ir->AddTetPoints24(330, 5.87403261246283614483e-01, 3.65326777598262708580e-01,
                            4.51384190574535271168e-02, 9.61331811479953357710e-05);
         ir->AddTetPoints24(354, 5.46396031738294984947e-01, 3.07811268979297336656e-01,
                            1.39969647691891629915e-01, 2.02977654799941771655e-04);
         ir->AddTetPoints24(378, 8.22016152550677281496e-01, 1.12725882095675467021e-01,
                            5.35628583336721364461e-02, 1.55167369282345750815e-04);
         ir->AddTetPoints24(402, 4.85270293755321213691e-01, 4.14951880808228645847e-01,
                            8.56940728509321125728e-02, 2.20720133665144613863e-04);
         ir->AddTetPoints24(426, 6.40061401596697221450e-01, 2.46021686137786854687e-01,
                            9.14046782308778893444e-02, 4.05811078830667370815e-04);
         ir->AddTetPoints24(450, 4.83969188803121397324e-01, 3.25141916246262097090e-01,
                            1.42813278017580813639e-01, 7.39894218301143384749e-04);
         ir->SetOrder(20);
