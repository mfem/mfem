...
struct d_regs3d_device_wrapper: mfem::future::tensor<real_t, 0, 0, 0, DIM> {};
template <int DIM, int N>
using d_regs3d_t = d_regs3d_device_wrapper<DIM, N>;

#else
template <int VDIM, int DIM, int N>
using vd_regs3d_t = mfem::future::tensor<real_t, N, N, N, VDIM, DIM>;

template <int DIM, int N>
using d_regs3d_t = mfem::future::tensor<real_t, N, N, N, DIM>;
#endif
