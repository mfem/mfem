                                 ...
                                 double * __restrict d_y)
{
   ...
   SYCL_KERNEL( // Q.submit
   {
      ...
      SYCL_FORALL_3D(e, NE, Q1D, Q1D, 1,
      {
         ...
         //SYCL_SHARED double sBG[MQ1*MD1];
         double *sBG = &localBG[0];
         ...
         //double *sm1= localSM1;
         //SYCL_SHARED double sm0[3][MDQ*MDQ*MDQ];
         //SYCL_SHARED double sm1[3][MDQ*MDQ*MDQ];
         double (*X)[MD1][MD1]    = (double (*)[MD1][MD1]) (sm0_2);
