                                       ...
                                       HypreParVector &x_single)
{
   ...
   MFEM_VERIFY(A_single.GetHyprePrecision() == precision,
               "A_single must be a single-precision hypre matrix");
   MFEM_VERIFY(b_single.GetHyprePrecision() == precision,
               "b_single must be a single-precision hypre vector");
...
int main(int argc, char *argv[])
{
   ...
   MFEM_VERIFY(sol_single.Size() == X.Size(), "");
   sol_single -= X;
   cout << "Rank " << myid << ": double-precision solution local norm "
        << X.Norml2() << ", single-precision error norm "
        << sol_single.Norml2() << endl;
