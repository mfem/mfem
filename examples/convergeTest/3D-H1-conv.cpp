                      ...
                      double &l2_err_prev, double &h1_err_prev, bool &visualization, int &exact, int &dof2view, int &solvePDE)
{
   ...
   {
      fec = new H1Ser_FECollection(order, 3);
   }
   else if (order < 0)
   {
...
int main(int argc, char *argv[])
{
   ...
   if (solvePDE == 1)
   {
      ...
      if (exact == 1)
      {
        cout << "exact solution u(x,y)=x+y+z" << endl;
      }
      else if (exact == 2)
      {
         cout << "exact solution u(x,y)=sin(sqrt(2)x) e^y e^z" << endl;
      }
      else
      {
   ...
   else if (solvePDE == 2)
   {
      ...
      if (exact == 1)
      {
        cout << "u(x,y)=x+y+z" << endl;
      }
      else if (exact == 2)
      {
         cout << "u(x,y)=sin(sqrt(2)x) e^y e^z" << endl;
      }
      else
      {
         cout << endl << "*** Wrong usage of exact solution parameter (-e)"
   ...
   if (dof2view != -1)
   {
      cout << "DEBUG option: solution deleted; just viewing global dof # " << dof2view << endl;
   }
