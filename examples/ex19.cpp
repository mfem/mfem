...
int main(int argc, char *argv[])
{
   ...
   FiniteElementCollection &quad_coll = *FECollection::NewH1(order, dim, mesh->NURBSext);
   FiniteElementCollection &lin_coll = *FECollection::NewH1(order-1, dim, mesh->NURBSext);
