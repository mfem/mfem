...
int main(int argc, char *argv[])
{
   ...
   int o = 0;
   int pyrType = 0;
   int mapType = (int)FiniteElement::VALUE;
   double d = 0.0;
   ...
   args.AddOption(&o, "-o", "--order", "Order");
   args.AddOption(&pyrType, "-p", "--pyramid-type", "0-Bergot, 1-Fuentes");
   args.AddOption(&mapType, "-mt", "--map-type", "0-VALUE, 1-INTEGRAL");
   ...
   L2_FECollection fec(o, 3, BasisType::GaussLegendre, mapType, pyrType);
