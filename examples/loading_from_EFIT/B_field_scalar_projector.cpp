...
int main(int argc, char *argv[])
{
    ...
    const char *gf_file = "output/B_tor_CG.gf"; // default value
    const char *gf_name = "B_tor_CG"; // default value
    ...
    FieldRGridFunctionCoefficient field_r_coef(&field, false);
    b.AddDomainIntegrator(new DomainLFIntegrator(field_r_coef));
    b.Assemble();
