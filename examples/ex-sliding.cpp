...
int main(int argc, char *argv[])
{
   ...
   /*
     // could do the following or something similar for star?
   {
      mesh->GetBdrElement(0)->SetAttribute(2);
      mesh->GetBdrElement(1)->SetAttribute(3);
      mesh->GetBdrElement(2)->SetAttribute(4);
      std::ofstream out("mess.mesh");
      mesh->Print(out);
   }
   */
   ...
   // 18. Save the refined mesh and the solution in VisIt format.
   {
      ...
      visitname << "sliding"; // could add a number?
