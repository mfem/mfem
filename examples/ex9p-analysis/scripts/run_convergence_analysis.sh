...
create_convergence="/Users/madisonsheridan/Workspace/mfem/examples/ex9p-analysis/scripts/create_convergence_table.py"
...
cd $mfem_dir
mpirun -np 8 ex9p-continuous -m ../data/periodic-square.mesh -dt .001 -rs 1 -rp 0 -p 4 -tf 2.84
mpirun -np 8 ex9p-continuous -m ../data/periodic-square.mesh -dt .001 -rs 2 -rp 0 -p 4 -tf 2.84
mpirun -np 8 ex9p-continuous -m ../data/periodic-square.mesh -dt .001 -rs 3 -rp 0 -p 4 -tf 2.84
mpirun -np 8 ex9p-continuous -m ../data/periodic-square.mesh -dt .001 -rs 4 -rp 0 -p 4 -tf 2.84
mpirun -np 8 ex9p-continuous -m ../data/periodic-square.mesh -dt .001 -rs 5 -rp 0 -p 4 -tf 2.84
mpirun -np 8 ex9p-continuous -m ../data/periodic-square.mesh -dt .001 -rs 6 -rp 0 -p 4 -tf 2.84
...
# mpirun -np 4 ex9p-continuous -m ../data/periodic-square.mesh -dt .001 -rs 9 -rp 0 -p 4 -tf 2.84
# mpirun -np 4 ex9p-continuous -m ../data/periodic-square.mesh -dt .001 -rs 10 -rp 0 -p 4 -tf 2.84
