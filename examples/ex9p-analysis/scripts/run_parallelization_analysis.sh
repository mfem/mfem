...
mpirun -np 1 ex9p-continuous -m ../data/periodic-square.mesh -dt 0.003 -rs 4 -rp 0 -p 4 -tf 2.84
mpirun -np 2 ex9p-continuous -m ../data/periodic-square.mesh -dt 0.003 -rs 4 -rp 0 -p 4 -tf 2.84
mpirun -np 4 ex9p-continuous -m ../data/periodic-square.mesh -dt 0.003 -rs 4 -rp 0 -p 4 -tf 2.84
