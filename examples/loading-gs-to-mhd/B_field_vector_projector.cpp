...
int main(int argc, char *argv[])
{
    ...
    const char *gf_file = "output/B_pol_Hdiv.gf"; // default value
    const char *gf_name = "B_pol_Hdiv"; // default value
    ...
    b.AddDomainIntegrator(new VectorFEDomainLFIntegrator(field_r_coef));
    b.Assemble();
