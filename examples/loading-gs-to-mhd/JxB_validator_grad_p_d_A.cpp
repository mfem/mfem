...
int main(int argc, char *argv[])
{
   ...
   ifstream temp_log("input/new_grad_p_iter_nd.gf");
   ...
   // paraview
   {
      ParaViewDataCollection paraview_dc("grad_p_d_A", new_mesh);
      ...
      paraview_dc.RegisterField("grad_p_d_A", &grad_p);
      paraview_dc.Save();
   }

   ofstream sol_ofs("output/grad_p_d_A.gf");
   sol_ofs.precision(8);
   grad_p.Save(sol_ofs);
