...
//
// Sample runs: mpirun -np 4 ex41p -r 3 -eta 1e2
//              mpirun -np 4 ex41p -m ../data/square-mixed.mesh -r 2 -eta 5
//              mpirun -np 4 ex41p -m ../data/square-disc.mesh -r 3 -eta 1 -mi 5000
