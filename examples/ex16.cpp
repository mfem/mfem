...
public:
   ConductionOperator(FiniteElementSpace &f, fptype alpha, fptype kappa,
                      const Vector &u);
...
fptype InitialTemperature(const Vector &x);
...
ConductionOperator::ConductionOperator(FiniteElementSpace &f, fptype al,
                                       fptype kap, const Vector &u)
   : TimeDependentOperator(f.GetTrueVSize(), (fptype) 0.0), fespace(f),
