...
int main(int argc, char *argv[])
{
   ...
   Mesh mesh = rotated_3dmesh(pi,pj);
   ...
   std::cout << "Ref norm: " << r_ref.ComputeL2Error(coeff) << '\n';
   std::cout << "Test norm: " << r_test.ComputeL2Error(coeff) << '\n';
   std::cout << "Difference norm: " << diff.Norml2() << '\n';
