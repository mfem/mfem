...
int main(int argc, char* argv[]) {
	...
	Dform.AddDomainIntegrator(new TransposeIntegrator(new GradientIntegrator(none))); 
	Dform.AddInteriorFaceIntegrator(new LDGTraceIntegrator(use_beta ? &beta : nullptr)); 
