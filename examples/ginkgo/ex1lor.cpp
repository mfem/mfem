...
int main(int argc, char *argv[])
{
    ...
    args.AddOption(&pc_storage_opt, "-pc-so", "--preconditioner-storage-optimization", 
    ...
    enum PCType { NONE, GKO_BLOCK_JACOBI, GKO_ILU };
    PCType pc_choice;
    bool pc = true;
      ...
      a_pc->FormSystemMatrix(ess_tdof_list, A_pc);
       ...
       if (pc_choice == GKO_BLOCK_JACOBI) {
          ...
          // Create Ginkgo Jacobi preconditioner
           ...
           GinkgoWrappers::GinkgoJacobiPreconditioner M(executor, A_pc, pc_storage_opt, pc_acc);
