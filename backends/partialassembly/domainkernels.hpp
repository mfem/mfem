...
template <typename Equation, typename Vector>
void DomainMult<Equation,PAOp::BtDG,Vector>::Mult1d(const Vector &U, Vector &V) const
{
   const int dim     = 1;
   const int dofs1d  = shape1d.Height();
...
template <typename Equation, typename Vector>
void DomainMult<Equation,PAOp::BtDG,Vector>::Mult2d(const Vector &U, Vector &V) const
{
   const int dim     = 2;
   const int dofs1d  = shape1d.Height();
   const int dofs    = dofs1d * dofs1d;
...
template <typename Equation, typename Vector>
void DomainMult<Equation,PAOp::BtDG,Vector>::Mult3d(const Vector &U, Vector &V) const
{
   const int dim     = 3;
   const int dofs1d  = shape1d.Height();
