...
// ***************************************************************************
//void RajaDiffusionIntegrator::SetOperator(RajaVector& v) { op = v; }

// ***************************************************************************
void RajaDiffusionIntegrator::MultAdd(RajaVector& x, RajaVector& y)
{
   push(SteelBlue);
...
// ***************************************************************************
void RajaMassIntegrator::SetOperator(RajaVector& v) {
   push();
   op = v;
   pop();
}
