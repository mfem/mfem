...
void rDiffusionAssemble2D0(const int numElements,
...
#endif
  {
    for (int q = 0; q < NUM_QUAD_2D; ++q) {
      ...
      oper[ijkNM(0,q,e,3,NUM_QUAD_2D)]/*(0, q, e)*/ =  c_detJ * (J21*J21 + J22*J22); // (1,1)
      oper[ijkNM(1,q,e,3,NUM_QUAD_2D)]/*(1, q, e)*/ = -c_detJ * (J21*J11 + J22*J12); // (1,2), (2,1)
      oper[ijkNM(2,q,e,3,NUM_QUAD_2D)]/*(2, q, e)*/ =  c_detJ * (J11*J11 + J12*J12); // (2,2)
   }
  }
#ifdef __LAMBDA__
          );
