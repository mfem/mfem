//              MFEM Example 4 - Parallel High-Performance Version
//
// Compile with: make ex4p
//
// Sample runs:  mpirun -np 4 ex4p -m ../../data/fichera.mesh -perf -mf  -pc lor
//               mpirun -np 4 ex4p -m ../../data/fichera.mesh -perf -asm -pc ho
//               mpirun -np 4 ex4p -m ../../data/fichera.mesh -perf -asm -pc ho -sc
//               mpirun -np 4 ex4p -m ../../data/fichera.mesh -std  -asm -pc ho
//               mpirun -np 4 ex4p -m ../../data/fichera.mesh -std  -asm -pc ho -sc
//               mpirun -np 4 ex4p -m ../../data/amr-hex.mesh -perf -asm -pc ho -sc
//               mpirun -np 4 ex4p -m ../../data/amr-hex.mesh -std  -asm -pc ho -sc
//               mpirun -np 4 ex4p -m ../../data/ball-nurbs.mesh -perf -asm -pc ho  -sc
//               mpirun -np 4 ex4p -m ../../data/ball-nurbs.mesh -std  -asm -pc ho  -sc
//               mpirun -np 4 ex4p -m ../../data/pipe-nurbs.mesh -perf -mf  -pc lor
//               mpirun -np 4 ex4p -m ../../data/pipe-nurbs.mesh -std  -asm -pc ho  -sc
//
...
int main(int argc, char *argv[])
{
   ...
   if (pc_choice == LOR)
   {
      ...
      fec_lor = new RT_FECollection(1, dim);
   ...
   if (pc_choice == LOR)
   {
      amg = new HypreADS(A_pc, fespace_lor);
      pcg->SetPreconditioner(*amg);
   }
   else if (pc_choice == HO)
   {
      amg = new HypreADS(A_pc, fespace);
      pcg->SetPreconditioner(*amg);
   }
