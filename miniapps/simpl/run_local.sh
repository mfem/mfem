...
do
  for i in 6 7 8 9 10
  do
    mpirun -np 8 ./mma -rs $i -rp 0 -p $p -no-vis -vs 10 -atol 1e-05 -rtol 1e-05 -ch 0.15 -mi 30
    mpirun -np 8 ./oc_org -rs $i -rp 0 -p $p -no-vis -vs 10 -atol 1e-05 -rtol 1e-05 -ch 0.15 -mi 30
    for back in $BACKTRACK
    do
      mpirun -np 8 ./simpl -rs $i -rp 0 -p $p $back -no-vis -vs 10 -atol 1e-05 -rtol 1e-05 -L2 -mi 30
    done
  done
done
