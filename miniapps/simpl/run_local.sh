...
make simpl -j
mpirun -np 8 ./simpl -rs 4 -rp 4 -p -21 -vs 1 -atol 1e-06 -rtol 1e-06 -bb
mv ParaView/SiMPL-A-ForceInverter2-8 ParaView/SiMPL-A-ForceInverter2-8-center
mv SiMPL-A-ForceInverter2-8.csv SiMPL-A-ForceInverter2-8-center.csv

# Compliant Mechanism with Initial Design connecting bottom
sed -i '' '65s/.*/   Vector domain_center\(\{1.0,0.0\}\);/' topopt_problems.cpp
make simpl -j
mpirun -np 8 ./simpl -rs 4 -rp 4 -p -21 -vs 1 -atol 1e-06 -rtol 1e-06 -bb
mv ParaView/SiMPL-A-ForceInverter2-8 ParaView/SiMPL-A-ForceInverter2-8-bottom
mv SiMPL-A-ForceInverter2-8.csv SiMPL-A-ForceInverter2-8-bottom.csv
