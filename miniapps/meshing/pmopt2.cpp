//
// BLAST test CPU:
//   mpirun -np 4 pmopt2 -m square01.mesh -o 2 -rs 2 -mid 7 -tid 5 -ni 5 -bnd -vl 1 -nor -lc 0.1 -ls 3 -pa -d cpu
// BLAST test GPU:
//   mpirun -np 4 pmopt2 -m square01.mesh -o 2 -rs 2 -mid 7 -tid 5 -ni 5 -bnd -vl 1 -nor -lc 0.1 -ls 3 -pa -d debug
//
...
int main (int argc, char *argv[])
{
   ...
   for (int i = 0; i < 3; i++)
   {
      ...
      if (normalization) { he_nlf_integ->ParEnableNormalization(x); }
