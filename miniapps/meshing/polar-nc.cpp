...
struct Params2
{
   ...
   Params2() = default;
   Params2(fptype r0, fptype r1, fptype a0, fptype a1)
      : r(r0), dr(r1 - r0), a(a0), da(a1 - a0) {}
};

Mesh* Make2D(int nsteps, fptype rstep, fptype phi, fptype aspect, int order,
             bool sfc)
{
   ...
   fptype prev_alpha = 0.0;
   for (int i = 0; i < n; i++)
   {
      fptype alpha = phi * (i+1) / n;
...
struct Params3
{
   ...
   Params3() = default;
   Params3(fptype r0, fptype r1,
           fptype u1, fptype v1, fptype u2, fptype v2, fptype u3, fptype v3)
...
int GetMidVertex(int v1, int v2, fptype r, fptype u, fptype v, bool hanging,
...
void MakeLayer(int vx1, int vy1, int vz1, int vx2, int vy2, int vz2, int level,
               fptype r1, fptype r2, fptype u1, fptype v1, fptype u2, fptype v2,
               fptype u3, fptype v3, bool bnd1, bool bnd2, bool bnd3, bool bnd4,
               Mesh *mesh, HashTable<Vert> &hash, Array<Params3> &params)
{
   ...
   {
      fptype u12 = (u1+u2)/2, v12 = (v1+v2)/2;
      fptype u23 = (u2+u3)/2, v23 = (v2+v3)/2;
      fptype u31 = (u3+u1)/2, v31 = (v3+v1)/2;
...
void MakeCenter(int origin, int vx, int vy, int vz, int level, fptype r,
                fptype u1, fptype v1, fptype u2, fptype v2, fptype u3, fptype v3,
...
Mesh* Make3D(int nsteps, fptype rstep, fptype aspect, int order, bool sfc)
{
   ...
   if (order > 1)
   {
      ...
      for (int i = 0; i < mesh->GetNE(); i++)
      {
         ...
         for (int j = 0; j < dofs.Size(); j++)
         {
            ...
            {
               fptype l1 = 1.0 - ip.x - ip.y;
               fptype l2 = ip.x, l3 = ip.y;
