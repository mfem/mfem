...
lrun -N$i1 -T$i0 -g1 pmesh-optimizer -m $i9 -mid 303 -tid 1 -vl 2 -bm -bnd -ni $newton_iter -art $solver_art_type -ls $i6 -qt 1 -$i8 -qo $i4 -li $i7 -o $i3 -st $i5 -rs $i2 -scale $init_scale -bm_id 2 -pt $partition -d cuda
