...
int main(int argc, char *argv[])
{
   ...
   if (dim == 2)
   {
      ...
      if (aspect_ratio)
      {
         ...
         fptype min_aspr = aspr_gf.Min(),
                max_aspr = aspr_gf.Max();
         max_aspr = std::max((fptype) 1.0/min_aspr, max_aspr);
   ...
   else if (dim == 3)
   {
      ...
      if (aspect_ratio)
      {
         ...
         fptype min_aspr1 = aspr_gf1.Min(),
                max_aspr1 = aspr_gf1.Max();
         max_aspr1 = std::max((fptype) 1.0/min_aspr1, max_aspr1);

         fptype min_aspr2 = aspr_gf2.Min(),
                max_aspr2 = aspr_gf2.Max();
         max_aspr2 = std::max((fptype) 1.0/min_aspr2, max_aspr2);
         fptype max_aspr = max(max_aspr1, max_aspr2);
         ...
         fptype min_aspr3 = aspr_gf3.Min(),
                max_aspr3 = aspr_gf3.Max();
         max_aspr3 = std::max((fptype) 1.0/min_aspr3, max_aspr3);
      ...
      if (skewness)
      {
         ...
         fptype min_skew1 = skew_gf1.Min(),
                max_skew1 = skew_gf1.Max();
         fptype min_skew2 = skew_gf2.Min(),
                max_skew2 = skew_gf2.Max();
         fptype min_skew3 = skew_gf3.Min(),
