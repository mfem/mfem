//                       MFEM Example 24 - Parallel Version, modified for NURBS FE
//
...
int main(int argc, char *argv[])
{
   ...
   ParFiniteElementSpace trial_fes(pmesh, NURBSext, trial_fec);
   ParFiniteElementSpace test_fes(pmesh, trial_fes.StealNURBSext(), test_fec);
