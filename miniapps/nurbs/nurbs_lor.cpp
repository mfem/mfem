...
int main(int argc, char *argv[])
{
   ...
   //    FiniteElementSpace *lo_fespace = new FiniteElementSpace(&lo_mesh, lo_fec);
...
//    ofstream results_ofs("nurbs_lor.csv", ios_base::app);
//    // If file does not exist, write the header
//    if (results_ofs.tellp() == 0)
//    {
//       results_ofs << "patcha, pa, pc, "           // integration & solver settings
