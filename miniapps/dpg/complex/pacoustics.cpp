...
int main(int argc, char *argv[])
{
   ...
   ScalarMatrixProductCoefficient omeg2_abs_Jt_J_detJinv_2(omeg2,abs_Jt_J_detJinv_2);
   MatrixRestrictedCoefficient omeg_Jt_J_detJinv_r_restr(omeg_Jt_J_detJinv_r,attrPML);
   MatrixRestrictedCoefficient omeg_Jt_J_detJinv_i_restr(omeg_Jt_J_detJinv_i,attrPML);
   MatrixRestrictedCoefficient negomeg_Jt_J_detJinv_r_restr(negomeg_Jt_J_detJinv_r,attrPML);
   ...
   //  i ω (u,v)
   a->AddTrialIntegrator(nullptr,new TransposeIntegrator(new VectorFEMassIntegrator(*omeg_cf)),1,1);
   // < p̂, v⋅n>
   ...
   // -i ω (∇q,δv)
   a->AddTestIntegrator(nullptr,new MixedVectorGradientIntegrator(*negomeg_cf),0,1);
   // i ω (v,∇ δq)
   a->AddTestIntegrator(nullptr,new MixedVectorWeakDivergenceIntegrator(*negomeg_cf),1,0);
   // ω^2 (v,δv)
   ...
   // i ω (q,∇⋅v)   
   a->AddTestIntegrator(nullptr,new MixedScalarWeakGradientIntegrator(*negomeg_cf),0,1);
   // ω^2 (q,δq)
