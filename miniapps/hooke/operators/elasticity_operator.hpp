...
public:
    ...
    */
   std::function<void(const int, const Array<fptype> &, const Array<fptype> &,
                      const Array<fptype> &, const Vector &, const Vector &,
                      const Vector &, Vector &)>
   ...
   void SetMaterial(const material_type &material)
   {
      ...
      element_apply_kernel_wrapper =
         [=](const int ne, const Array<fptype> &B_, const Array<fptype> &G_,
             const Array<fptype> &W_, const Vector &Jacobian_,
