...
template <int dim> struct LinearElasticMaterial
{
    ...
    */
   tensor<mfem::fptype, dim, dim>
   MFEM_HOST_DEVICE stress(const tensor<mfem::fptype, dim, dim> &dudx) const
   {
    ...
    *
    */
   tensor<mfem::fptype, dim, dim> MFEM_HOST_DEVICE
    ...
    */
   tensor<mfem::fptype, dim, dim, dim, dim>
   MFEM_HOST_DEVICE gradient(tensor<mfem::fptype, dim, dim> /* dudx */) const
   {
