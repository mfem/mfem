             ...
             const material_type &material)
{
   ...
   mfem::forall_3D(ne, q1d, q1d, q1d, [=] MFEM_HOST_DEVICE (int e)
   {
      ...
      MFEM_SHARED tensor<fptype, 2, 3, q1d, q1d, q1d> smem;
      // cauchy stress
      MFEM_SHARED_3D_BLOCK_TENSOR(invJ_sigma_detJw, fptype, q1d, q1d, q1d, dim, dim);
      // du/dxi
      MFEM_SHARED_3D_BLOCK_TENSOR(dudxi, fptype, q1d, q1d, q1d, dim, dim);
                     ...
                     Vector &dsigma_cache_)
{
   ...
   mfem::forall_3D(ne, q1d, q1d, q1d, [=] MFEM_HOST_DEVICE (int e)
   {
      ...
      MFEM_SHARED tensor<fptype, 2, 3, q1d, q1d, q1d> smem;
      // cauchy stress
      MFEM_SHARED tensor<fptype, q1d, q1d, q1d, dim, dim> invJ_dsigma_detJw;
      // du/dxi, ddu/dxi
      MFEM_SHARED_3D_BLOCK_TENSOR( dudxi, fptype, q1d, q1d, q1d, dim, dim);
      MFEM_SHARED_3D_BLOCK_TENSOR(ddudxi, fptype, q1d, q1d, q1d, dim, dim);
      ...
      MFEM_FOREACH_THREAD(qx, x, q1d)
      {
         MFEM_FOREACH_THREAD(qy, y, q1d)
         {
            MFEM_FOREACH_THREAD(qz, z, q1d)
            {
               ...
               {
                  // C = dsigma/dudx
                  tensor<fptype, dim, dim, dim, dim> C;
                                ...
                                const material_type &material)
{
   ...
   mfem::forall_3D(ne, q1d, q1d, q1d, [=] MFEM_HOST_DEVICE (int e)
   {
      ...
      // du/dxi
      MFEM_SHARED_3D_BLOCK_TENSOR(dudxi, fptype, q1d, q1d, q1d, dim, dim);
      MFEM_SHARED_3D_BLOCK_TENSOR(Ke_diag, fptype, d1d, d1d, d1d, dim, dim);
      ...
      MFEM_FOREACH_THREAD(qx, x, q1d)
      {
         MFEM_FOREACH_THREAD(qy, y, q1d)
         {
            MFEM_FOREACH_THREAD(qz, z, q1d)
            {
               ...
               const fptype JxW = detJ(qx, qy, qz, e) * qweights(qx, qy, qz);
