...
int main(int argc, char *argv[])
{
   ...
   double dirichletVal = 4.16; //0.389807; //0.389874;
   ...
   {
      solver->AddDirichletBC(2,0.0);
      solver->AddDirichletBC(4,dirichletVal);
   }
   else{
      solver->AddDirichletBC(4,0.0);
      solver->AddDirichletBC(2,dirichletVal);
   }
...
//----------------------------------------------------------
   ...
   //solve
   int NumTimeSteps = 1;
   solver->SetNewtonSolver(1e-11, 1e-12,25, 1, 1.0);
