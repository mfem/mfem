...
int main(int argc, char *argv[])
{
   ...
   //double max_vol = 1.08;
   double maxEnergydissipationAllowed = 5e-4;
   ...
   if(true)
   {
      ...
      for(int i=1;i<max_it;i++)
      {
         ...
         if(myrank==0)
         {
             std::cout<<"it: "<<i<<" | obj= "<<thermalCompliance<<" | energyDissip= "<<energyDissip<<" | Constraint: "<< energyDissip-maxEnergydissipationAllowed<<std::endl;
         }
