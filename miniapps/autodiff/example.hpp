...
public:
                                   ...
                                   const Vector &elfun)
   {
      ...
      MyEnergyFunctor<fptype,Vector,Vector,4,3> qfunc;
...
public:
                                    ...
                                    DenseMatrix &elmat)
   {
      ...
      fptype w; // integration weight
      fptype detJ;
      fptype nrgrad; // norm of the gradient
      fptype aa0; // original nonlinear diffusion coefficient
      fptype aa1; // gradient of the above
      fptype ppp = 2.0; // power in the P-Laplacian
      fptype eee = 0.0; // regularization parameter
