EXEC="mpirun -np 6 phypsys"

SCHEME=1
MESH=data/wall-bdr-4segment.mesh

## SOD Shock tube
CONFIG="-p 5 -c 1 -vs 1000 -tf 0.231 -s 3 -m $MESH -e $SCHEME"
...
# CONFIG="-p 5 -c 2 -vs 1000 -tf 0.038 -s 3 -m $MESH -e $SCHEME"
# $EXEC $CONFIG -o 1 -r 2 -dt 1e-6


## Double Mach reflection
MESH=data/double-mach-quad.mesh
CONFIG="-p 5 -c 3 -vs 1000 -tf 0.2 -s 3 -m $MESH -e $SCHEME"
...
# CONFIG="-p 5 -c 0 -vs 100 -tf 2 -s 3 -dt 0.0008 -m $MESH -e $SCHEME"
