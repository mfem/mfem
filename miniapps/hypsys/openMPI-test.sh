...
# Translation
CONFIG="-p 0 -c 2 -vs 100 -tf 0.4 -s 3 -dt 0.002 -m data/periodic-tri.mesh -o 2 -r 3 -e $SCHEME"
./hypsys $CONFIG
./phypsys $CONFIG
...
## KPP
CONFIG="-p 2 -c 1 -vs 50 -tf 0.25 -s 3 -dt 0.005 -m data/inline-4tri.mesh -o 0 -r 4 -e 0"
./hypsys $CONFIG
./phypsys $CONFIG
