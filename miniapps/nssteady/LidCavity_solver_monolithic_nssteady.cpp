...
//
// Run with:
// mpirun -np 4 ./LidCavity_solver_monolithic_nssteady -d 2 -e 1 -n 10 -rs 0 -rp 0 -re 100 -pic -1 -ov 2 -op 1 -rel 1e-7 -abs 1e-6 -it 1000 -g 1.0 -a 1.0 -p --verbose -o Output-Folder
//
