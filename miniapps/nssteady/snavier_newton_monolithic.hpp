...
/**
 * \class SNavierNewtonMonolithicSolver
...
public:
    ...
    SNavierNewtonMonolithicSolver(ParMesh* mesh,int vorder=2, int porder=1, double kin_vis_=0, bool verbose=false);

    ~SNavierNewtonMonolithicSolver();
...
private:
    ...
    ParBilinearForm      *C1_form = nullptr; 
    ...
    HypreParMatrix     *C1 = nullptr;         // convective term   w . grad u
