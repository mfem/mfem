...
public:
                          ...
                          ElementTransformation &trans, const Vector &lsfun)
    {
        ...
        if(el.GetGeomType()==Geometry::Type::CUBE)
        {
...
private:
    ...
    struct LevelSet3D
    {
        ...
        LevelSet3D(PositiveTensorFiniteElement* el_, Vector& lsfun_):el(el_),lsfun(lsfun_)
        {
    ...
    struct LevelSet2D
    {
        ...
        LevelSet2D(PositiveTensorFiniteElement* el_, Vector& lsfun_):el(el_),lsfun(lsfun_)
        {
