...
public:
   ...
   void Extrapolate(Coefficient &level_set, const ParGridFunction &input,
                    const fptype time_period, ParGridFunction &xtrap);
   ...
   void ComputeLocalErrors(Coefficient &level_set, const ParGridFunction &exact,
                           ...
                           fptype &err_L1, fptype &err_L2, fptype &err_LI);

private:
   void TimeLoop(ParGridFunction &sltn, ODESolver &ode_solver, fptype t_final,
                 fptype dt, int vis_x_pos, std::string vis_name);
};
...
public:
                     ...
                     const IntegrationPoint &ip)
   {
      ...
      const fptype norm_grad = grad_ls.Norml2();
      V = grad_ls;
