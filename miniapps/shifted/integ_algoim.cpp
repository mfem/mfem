...
const IntegrationRule* AlgoimIntegrationRule::GetVolumeIntegrationRule()
{
    ...
    if(dim==2)
    {
        ...
        auto q = Algoim::quadGen<2>(ls,Algoim::BoundingBox<double,2>(0.0,1.0),-1,-1, int_order);
        ...
        auto q = Algoim::quadGen<3>(ls,Algoim::BoundingBox<double,3>(0.0,1.0),-1,-1, int_order);
...
const IntegrationRule* AlgoimIntegrationRule::GetSurfaceIntegrationRule()
{
    ...
    {
        LevelSet2D ls(pe,lsvec);
        auto q = Algoim::quadGen<2>(ls,Algoim::BoundingBox<double,2>(0.0,1.0),2,-1, int_order);
        ...
        LevelSet3D ls(pe,lsvec);
        auto q = Algoim::quadGen<3>(ls,Algoim::BoundingBox<double,3>(0.0,1.0),3,-1, int_order);
