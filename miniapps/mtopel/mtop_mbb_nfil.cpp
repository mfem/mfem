...
int main(int argc, char *argv[])
{
   ...
   if(dim==2){//2D force
         volforce=new mfem::VolForce(0.05,2.90,0.5,0.0,-1.0);} //cantilever
//       volforce=new mfem::VolForce(0.05,2.50,2.10,0.0,-1.0);} //portal frame
   ...
   mfem::Vector ograd(fsolv->GetDesignFES()->GetTrueVSize()); ograd=0.0; //of the objective
   mfem::Vector vgrad(fsolv->GetDesignFES()->GetTrueVSize()); vgrad=0.0; //of the volume contr.
