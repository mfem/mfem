...
public:
   ...
   FilterSolver(double r_, mfem::ParMesh* pmesh_,
                mfem::ParFiniteElementSpace* dfes_,int order_=2):dfes(dfes_)
   {
      r=r_;
      order=order_;
      pmesh=pmesh_;
   ...
   void SetSolver(double rtol_=1e-8, double atol_=1e-12,int miter_=1000,
                  int prt_level_=1)
   {
      rtol=rtol_;
      atol=atol_;
