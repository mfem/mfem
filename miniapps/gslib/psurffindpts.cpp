...
//
// Sample runs:
//    make psurffindpts -j && mpirun -np 1 psurffindpts -m ../meshing/blade.mesh -mo 4 -o 1 -vis
...
int main (int argc, char *argv[])
{
   ...
   ParMesh pmesh(MPI_COMM_WORLD, submesh);

   // Curve the mesh based on the chosen polynomial degree.
   ParGridFunction *x = dynamic_cast<ParGridFunction *>(pmesh.GetNodes());
