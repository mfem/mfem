...
//
// Compile with: make pfindptsclean
//
// Sample runs:
//    mpirun -np 2 pfindptsclean -m ../../data/rt-2d-p4-tri.mesh -o 4
//    mpirun -np 2 pfindptsclean -m ../../data/inline-tri.mesh -o 3
//    mpirun -np 2 pfindptsclean -m ../../data/inline-quad.mesh -o 3
//    mpirun -np 2 pfindptsclean -m ../../data/inline-quad.mesh -o 3 -po 1
//    mpirun -np 2 pfindptsclean -m ../../data/inline-quad.mesh -o 3 -po 1 -gfo 1 -nc 2
//    mpirun -np 2 pfindptsclean -m ../../data/inline-quad.mesh -o 3 -hr
//    mpirun -np 2 pfindptsclean -m ../../data/inline-tet.mesh -o 3
//    mpirun -np 2 pfindptsclean -m ../../data/inline-hex.mesh -o 3
//    mpirun -np 2 pfindptsclean -m ../../data/inline-wedge.mesh -o 3
//    mpirun -np 2 pfindptsclean -m ../../data/amr-quad.mesh -o 2
//    mpirun -np 2 pfindptsclean -m ../../data/rt-2d-q3.mesh -o 3 -mo 4 -ft 2
//    mpirun -np 2 pfindptsclean -m ../../data/inline-quad.mesh -ft 1 -no-vis -sr0
//    mpirun -np 2 pfindptsclean -m ../../data/square-mixed.mesh -o 2 -mo 2
//    mpirun -np 2 pfindptsclean -m ../../data/square-mixed.mesh -o 2 -mo 2 -hr
//    mpirun -np 2 pfindptsclean -m ../../data/square-mixed.mesh -o 2 -mo 3 -ft 2
//    mpirun -np 2 pfindptsclean -m ../../data/fichera-mixed.mesh -o 3 -mo 2
//    mpirun -np 2 pfindptsclean -m ../../data/inline-pyramid.mesh -o 1 -mo 1
//    mpirun -np 2 pfindptsclean -m ../../data/tinyzoo-3d.mesh -o 1 -mo 1

// make pfindptsclean -j && mpirun -np 5 pfindptsclean -d debug -rs 2 -mo 3 -o 3 -nc 2 -po 1 -gfo 1 -eo 1
// quads, third-order mesh, second-order gridfunction
// make pfindptsclean -j && mpirun -np 5 pfindptsclean -d debug -rs 0 -mo 3 -o 2 -nc 2 -eo 2 -po 1 -gfo 1 -et 0 -vis -dim 2
// hex
// make pfindptsclean -j && mpirun -np 5 pfindptsclean -d debug -rs 0 -mo 3 -o 2 -nc 2 -eo 2 -po 1 -gfo 1 -et 0 -vis -dim 3
// tets
// make pfindptsclean -j && mpirun -np 5 pfindptsclean -d debug -rs 0 -mo 3 -o 3 -nc 2 -eo 2 -po 1 -gfo 1 -et 1 -vis -dim 3
