...
int main(int argc, char *argv[])
{
   ...
   FiniteElementCollection *vel_fec = nullptr;
   FiniteElementCollection *pres_fec = nullptr;

   {
      vel_fec = new RT_FECollection(order, dim));
      pres_fec = new L2_FECollection(order, dim));
   }
   
   FiniteElementSpace *U_space = nullptr;
   FiniteElementSpace *P_space = nullptr;

   {
      U_space = new FiniteElementSpace(mesh, vel_fec);
      P_space = new FiniteElementSpace(mesh, pres_fec);
   }
   ...
   std::cout << "***********************************************************\n";
   std::cout << "dim(vel)   = " << block_offsets[1] - block_offsets[0] << "\n";
   std::cout << "dim(pres)  = " << block_offsets[2] - block_offsets[1] << "\n";
   std::cout << "dim(total) = " << block_offsets.Last() << "\n";
   std::cout << "***********************************************************\n";
   ...
   BilinearForm *mVarf(new BilinearForm(U_space));
   MixedBilinearForm *bVarf(new MixedBilinearForm(U_space, P_space));
