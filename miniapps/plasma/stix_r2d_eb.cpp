...
int main(int argc, char *argv[])
{
   ...
   int num_elements_x = 10;
   int num_elements_y = 10;
   int elem_type = (int)Element::QUADRILATERAL;
   real_t length_x = 1.0;
   real_t length_y = 1.0;
   ...
   args.AddOption(&mesh_file, "-m", "--mesh",
                  "Two dimensional mesh file to use.");
   args.AddOption(&num_elements_x, "-nex", "--num-elems-x",
                  "Number of elements in the x-direction in initial mesh.");
   args.AddOption(&num_elements_y, "-ney", "--num-elems-y",
                  "Number of elements in the y-direction in initial mesh.");
   ...
   args.AddOption(&length_y, "-Ly", "--length-y",
   ...
   if (mesh_file != "")
     ...
     {
       mesh = Mesh::MakeCartesian2D(num_elements_x, num_elements_y,
