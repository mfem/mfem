...
CPDInputVis::CPDInputVis(StixParams &stixParams,
  ...
  : sfes_(l2_sfes),
    ...
    //
    stixSReCoef_(stixParams, true),
    stixSImCoef_(stixParams, false),
    stixDReCoef_(stixParams, true),
    stixDImCoef_(stixParams, false),
    stixPReCoef_(stixParams, true),
    stixPImCoef_(stixParams, false),
    stixS_("StixS", l2_sfes.get(), cyl, false),
    stixD_("StixD", l2_sfes.get(), cyl, false),
    stixP_("StixP", l2_sfes.get(), cyl, false),
    //
    lambdaLCoef_('L', stixParams, true),
    lambdaRCoef_('R', stixParams, true),
    lambdaOCoef_('O', stixParams, true),
    lambdaXCoef_('X', stixParams, true),
    ...
    //
    deltaLCoef_('L', stixParams, false),
    deltaRCoef_('R', stixParams, false),
    deltaOCoef_('O', stixParams, false),
    deltaXCoef_('X', stixParams, false),
...
CPDOutputVis::CPDOutputVis(StixParams &stixParams,
  ...
  : sfes_(l2_sfes),
    vfes_(l2_vfes),
    omega_(omega),
    epsReCoef_(stixParams, true),
    epsImCoef_(stixParams, false),
    muInvCoef_(1.0 / mu0_),
...
CPDSolverEB::CPDSolverEB(ParMesh & pmesh, int order,
   ...
   : myid_(0),
     ...
     current_(*HCurlFESpace_, *HDivFESpace_, omega_, conv,
              stixBCs.GetCurrentSrcs(), nbcs_, kReCoef, kImCoef),
...
{
   std::cout << "Entering CPDSolverEB d'tor\n";
   ...
   std::cout << "Exiting CPDSolverEB d'tor\n";
}
...
CPDSolverEB::Update()
{
   ...
   // if (L2FESpacep_) { L2FESpacep_->Update(); }
   // if (L2VFESpacep_) { L2VFESpacep_->Update(); }
