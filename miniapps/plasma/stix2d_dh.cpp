...
public:
   ...
   void setNue(double nue){nue_ = nue;}
...
int main(int argc, char *argv[])
{
   ...
   */
   ...
   ParGridFunction mu_gf(&L2FESpace);
   ...
   */
   ...
   MatrixCoefficient *muPML_real = NULL;
   MatrixCoefficient *muPML_imag = NULL;
   ...
   //MatrixComponentCoefficient muMatCoef(*muPML_real,0,0);
   //mu_gf.ProjectCoefficient(muMatCoef);
   ...
   if (wave_type[0] == 'J' && slab_params_.Size() == 7)
   {
      EReCoef.SetCurrentSlab(slab_params_[1], slab_params_[3], slab_params_[5],
                             0.24);
      EImCoef.SetCurrentSlab(slab_params_[1], slab_params_[3], slab_params_[5],
                             0.24);

      HReCoef.SetCurrentSlab(slab_params_[1], slab_params_[3], slab_params_[5],
                             0.24);
      HImCoef.SetCurrentSlab(slab_params_[1], slab_params_[3], slab_params_[5],
                             0.24);
   }
   ...
   if ( visit )
   {
      ...
      visit_dc.RegisterField("MU_XX", &mu_gf);
   ...
   for (int it = 1; it <= maxit; it++)
   {
      ...
      if (wave_type[0] != ' ')
      {
         ...
         */
         ...
         if (Mpi::Root())
         {
            cout << "Global Relative L2 Error in E field: " << glb_error_E << endl;
         }
      }
