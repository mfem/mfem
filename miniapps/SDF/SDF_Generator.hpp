...
//-------------------------------------------------------------------------------
        ...
        struct Data
        {
            ...
            const unsigned int           mNumberOfTriangles;            // !< number of triangles in object

            //!< counter for unsure nodes in voxelizing algorithm
            unsigned int                 mUnsureNodesCount;

            mfem::Vector mTriangleMinCoordsX;    //!< min coordinate x of triangle bounding box
            mfem::Vector mTriangleMinCoordsY;    //!< min coordinate y of triangle bounding box
            mfem::Vector mTriangleMinCoordsZ;    //!< min coordinate z of triangle bounding box
            mfem::Vector mTriangleMaxCoordsX;    //!< max coordinate x of triangle bounding box
            mfem::Vector mTriangleMaxCoordsY;    //!< max coordinate y of triangle bounding box
            mfem::Vector mTriangleMaxCoordsZ;    //!< max coordinate x of triangle bounding box
            mfem::Array<unsigned int> mCandJ;    //!< temporary variable needed for triangle preselection

            mfem::Vector mCoordsK;                //!< temporary variable needed for voxelizing
