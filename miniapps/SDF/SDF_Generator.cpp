...
//-------------------------------------------------------------------------------
        ...
        Core::calculate_raycast_and_sdf( mfem::Vector & aSDF )
        {
            ...
            std::vector< Vertex * > tCandidateList;  //========================================
...
//-------------------------------------------------------------------------------
        ...
        void Core::intersect_triangles( const unsigned int aAxis, const mfem::Vector & aPoint )
        {
...
//            int tNumberOfNodes = mMesh.get_num_nodes();
            ...
            int tNumberOfCandidates = aCandList.size(); //========================================
...
//            {
            ...
            for( int k=0; k<tNumberOfCandidates; k++ )  //========================================
            {
                // get pointer to node
//                Vertex * tNode = mMesh.get_vertex( k );
