     ...
     solver_(hdiv_space->GetComm())
{
   ...
   for (int elem_idx = 0; elem_idx < num_elements; ++elem_idx)
   {
      ...
      // hdiv_matrix.Threshold(eps * hdiv_matrix.MaxMaxNorm());
      ...
      // mixed_matrix.Threshold(eps * mixed_matrix.MaxMaxNorm());
      ...
      product_matrix.Threshold(eps * product_matrix.MaxMaxNorm());
