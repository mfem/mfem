...
//  2. AMGF requires a parallel direct solver for the filtered subspace; build
//     MFEM with MUMPS or MKL CPardiso. If unavailable, requesting -amgf aborts
//     with an error.
//  3. This miniapp requires MFEM build with Tribol, an open source contact mechanics library
...
int main(int argc, char *argv[])
{
   ...
   // 2. Select mesh file based on the chosen benchmark.
