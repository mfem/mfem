...
// from the center), plus a sixth equal-radius hole centered at the origin.
// Parametric Gmsh input file for MFEM-compatible 2-D meshes.
//
// Generate a mesh after editing the USER OPTIONS block below:
//   gmsh circular_6_holes_pentagon_center.geo -2 -o circular_6_holes_pentagon_center.msh
//
// MFEM notes:
...
outerRadius = 1.000;
holeRadius = 0.050;       // same radius for all six circular holes
centerHoleRadius = 0.100; // radius of the sixth, centrally-placed hole
radialHoleOffset = 0.900; // distance from center to each pentagon hole center
// Angle (degrees) of the first hole, measured counter-clockwise from the
// positive x-axis. The remaining four pentagon holes are placed at
// 72-degree increments from this one, giving a regular pentagon arrangement.
startAngleDeg = 90;
// -----------------------------------------------------------------------------
// END USER OPTIONS
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Hole 6 - centered at the origin (0, 0).
// -----------------------------------------------------------------------------
Point(31) = {0, 0, 0, meshSize};
Point(32) = {0 + centerHoleRadius, 0, 0, meshSize};
Point(33) = {0, 0 + centerHoleRadius, 0, meshSize};
Point(34) = {0 - centerHoleRadius, 0, 0, meshSize};
Point(35) = {0, 0 - centerHoleRadius, 0, meshSize};
Circle(25) = {32, 31, 33};
Circle(26) = {33, 31, 34};
Circle(27) = {34, 31, 35};
Circle(28) = {35, 31, 32};
Curve Loop(7) = {25, 26, 27, 28};
Physical Curve("hole_6", 7) = {25, 26, 27, 28};
...
// boundary attribute 107 (curve id 25..28): hole_6  (center)
