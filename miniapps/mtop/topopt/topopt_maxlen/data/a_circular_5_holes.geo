...
//   gmsh a_circular_5_holes.geo -2 -o a_circular_5_holes.msh
//
// MFEM notes:
...
radialHoleOffset = 0.900; // distance from center to the four satellite holes
// -----------------------------------------------------------------------------
// END USER OPTIONS
// -----------------------------------------------------------------------------
...
Point(7) = {(0) + (holeRadius), 0, 0, meshSize};
Point(8) = {0, (0) + (holeRadius), 0, meshSize};
Point(9) = {(0) - (holeRadius), 0, 0, meshSize};
Point(10) = {0, (0) - (holeRadius), 0, meshSize};
Circle(5) = {7, 6, 8};
Circle(6) = {8, 6, 9};
Circle(7) = {9, 6, 10};
Circle(8) = {10, 6, 7};
Curve Loop(2) = {5, 6, 7, 8};
Physical Curve("hole_center", 2) = {5, 6, 7, 8};
...
Physical Curve("hole_east", 3) = {9, 10, 11, 12};
Point(16) = {0, radialHoleOffset, 0, meshSize};
Point(17) = {(0) + (holeRadius), radialHoleOffset, 0, meshSize};
Point(18) = {0, (radialHoleOffset) + (holeRadius), 0, meshSize};
Point(19) = {(0) - (holeRadius), radialHoleOffset, 0, meshSize};
Point(20) = {0, (radialHoleOffset) - (holeRadius), 0, meshSize};
Circle(13) = {17, 16, 18};
Circle(14) = {18, 16, 19};
Circle(15) = {19, 16, 20};
Circle(16) = {20, 16, 17};
Curve Loop(4) = {13, 14, 15, 16};
Physical Curve("hole_north", 4) = {13, 14, 15, 16};
Point(21) = {-radialHoleOffset, 0, 0, meshSize};
Point(22) = {(-radialHoleOffset) + (holeRadius), 0, 0, meshSize};
Point(23) = {-radialHoleOffset, (0) + (holeRadius), 0, meshSize};
Point(24) = {(-radialHoleOffset) - (holeRadius), 0, 0, meshSize};
Point(25) = {-radialHoleOffset, (0) - (holeRadius), 0, meshSize};
Circle(17) = {22, 21, 23};
Circle(18) = {23, 21, 24};
Circle(19) = {24, 21, 25};
Circle(20) = {25, 21, 22};
Curve Loop(5) = {17, 18, 19, 20};
Physical Curve("hole_west", 5) = {17, 18, 19, 20};
Point(26) = {0, -radialHoleOffset, 0, meshSize};
Point(27) = {(0) + (holeRadius), -radialHoleOffset, 0, meshSize};
Point(28) = {0, (-radialHoleOffset) + (holeRadius), 0, meshSize};
Point(29) = {(0) - (holeRadius), -radialHoleOffset, 0, meshSize};
Point(30) = {0, (-radialHoleOffset) - (holeRadius), 0, meshSize};
Circle(21) = {27, 26, 28};
Circle(22) = {28, 26, 29};
Circle(23) = {29, 26, 30};
Circle(24) = {30, 26, 27};
Curve Loop(6) = {21, 22, 23, 24};
Physical Curve("hole_south", 6) = {21, 22, 23, 24};
...
// boundary attribute 102: hole_center
// boundary attribute 103: hole_east
// boundary attribute 104: hole_north
// boundary attribute 105: hole_west
// boundary attribute 106: hole_south

Physical Surface("domain", 1) = {1};
Physical Surface("hole_center", 2) = {2};
Physical Surface("hole_east", 3) = {3};
Physical Surface("hole_north", 4) = {4};
Physical Surface("hole_west", 5) = {5};
Physical Surface("hole_south", 6) = {6};