/**
 * test_mma_gcmma.cpp  —  MMA GCMMA-only test suite
 *
 ...
 * Run:    ./build/test_mma_gcmma              (1 rank, serial + parallel)
 *         mpirun -np 4 ./build/test_mma_gcmma (4 ranks, parallel path exercised)
 */
