/**
 * test_sq_gcmma.cpp  —  SQOptimizer SQ-GCMMA test suite
 *
 * Same problems as test_gcmma.cpp using SQOptimizer::UpdateGCMMA().
 * The SQ approximation replaces the MMA reciprocal model while the
 * GCMMA conservatism loop (inner iterations) remains identical.
 *
