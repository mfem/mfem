 ...
 *   mpirun -np 4 ./ex41p_stokes_adv_diff_cg -m ../data/periodic-square.mesh -rs 2 -rp 1 -o 2 -fa 5 -nu 0.01 -dt 0.005 -tf 2.0 -pv -pvs 20
 *
 *   # Non-periodic (no-slip walls), higher forcing
 *   mpirun -np 4 ./ex41p_stokes_adv_diff_cg -m ../data/square-disc.mesh -rs 2 -rp 1 -o 2 -fa 10 -nu 0.01 -dt 0.005 -tf 1.0 -pv
 */
//
// ---------------------------------------------------------------------------
// Description:
