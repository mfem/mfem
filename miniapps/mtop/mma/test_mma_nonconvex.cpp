/**
 * test_mma_nonconvex.cpp  —  Non-convex large-scale MMA/GCMMA test suite
 *
 ...
 * Run:    ./build/test_mma_nonconvex
 *         mpirun -np 4 ./build/test_mma_nonconvex
 *         ./build/test_mma_nonconvex --large
 */
