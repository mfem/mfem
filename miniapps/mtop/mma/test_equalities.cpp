 ...
 *
 *  5. Parallel equality  (MMAOptimizerParallel::WithEqualities)
...
static void Test_MixedConstraints()
{
    ...
    for (int it=0;it<1000&&kkt>1e-9 && !std::isnan(double(kkt));++it){
        ...
        Vector fi_ineq(1); fi_ineq(0)=real_t(xmean-(Vfrac+0.05));
        Vector h_eq(1);    h_eq(0)   =real_t(xmean-Vfrac);
...
// ============================================================
// Test 5: parallel equality (MMAOptimizerParallel::WithEqualities)
// ============================================================
...
int main(int argc, char** argv)
{
    ...
    if (g_rank==0)
        printf("╔══════════════════════════════════════════════════════════╗\n"
               "║  Equality-constraint test suite  (%2d rank(s))           ║\n"
               "╠══════════════════════════════════════════════════════════╣\n"
               "║  Tests WithEqualities(), PackFival(), PackedDfidx        ║\n"
               "║  Equality multipliers: free sign in dual IP loop         ║\n"
               "╚══════════════════════════════════════════════════════════╝\n",
               nranks);
