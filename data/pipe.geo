...
// ---- Parameters ----
Ro = 3.0;    // outer radius of the tube
Ri = 1.5;    // inner radius (bore)
...
lc = 2.0;    // cross-section mesh size
nz = 2;      // layers along the vertical run
nb = 4;      // layers around the bend
nh = 2;      // layers along the horizontal stub
