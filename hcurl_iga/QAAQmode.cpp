...
//
// Compile with: make QAAQmode
//
// Sample runs:  mpirun -np 1 QAAQmode
//
...
int main(int argc, char *argv[])
{
   ...
   std::ifstream file_x_r("./pndnurbs-adusol_r.gf");
   std::ifstream file_x_i("./pndnurbs-adusol_i.gf");
   ...
   ofstream J_r_ofs("aduJ_r.gf");
   ofstream J_i_ofs("aduJ_i.gf");
