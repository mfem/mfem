...
//
// Compile with: make QAAQmode_bend_in
//
// Sample runs:  mpirun -np 1 QAAQmode_bend_in
//
...
int main(int argc, char *argv[])
{
   ...
   std::ifstream file_x_r("./bend_in_nurbs-sol_r.gf");
   std::ifstream file_x_i("./bend_in_nurbs-sol_i.gf");
   ...
   ofstream J_r_ofs("bend_in_J_r.gf");
   ofstream J_i_ofs("bend_in_J_i.gf");
   ...
   pd->SetPrefixPath("./bendinParaview");
