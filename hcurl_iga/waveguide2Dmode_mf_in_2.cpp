...
//
// Compile with: make waveguide2Dmode_mf_in_2
//
// Sample runs:  mpirun -np 1 waveguide2Dmode_mf_in_2
//
...
int main(int argc, char *argv[])
{
   ...
   ofstream sol_r_ofs("mf_in_2_nurbs-sol_r.gf");
   ofstream sol_i_ofs("mf_in_2_nurbs-sol_i.gf");
   ...
   pd->SetPrefixPath("./ParaViewMFin2Mode");
