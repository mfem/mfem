...
//
// Compile with: make test_nurbs
//
// Sample runs:  test_nurbs -m ../../data/square-nurbs.mesh
//               test_nurbs -m ../../data/square-nurbs.mesh -o 2
//               test_nurbs -m ../../data/cube-nurbs.mesh
//
...
public:
   ...
   { 
      ...
      // std::cout<<"主程序第97行 "<<K.Size()<<std::endl;
...
int main(int argc, char *argv[])
{
   ...
   cout << "Size of linear system: " << A->Height() << endl;
    ...
    mfem::out<<"main.cpp: test row 359 "<< (*PCOpAh.As<SparseMatrix>()).Finalized()<<std::endl;
  ...
  ofstream mesh_ofs("testnurbs.mesh");
  mesh_ofs.precision(8);
  mesh->Print(mesh_ofs);

  ofstream sol_r_ofs("testnurbs-sol_r.gf");
  ofstream sol_i_ofs("testnurbs-sol_i.gf");
  ...
  x.imag().Save(sol_i_ofs);
   ...
   pd = new ParaViewDataCollection("nd_nurbs", mesh);
