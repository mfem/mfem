...
//
// Sample runs:  mpirun -np 1 IGAopt
//
...
int main(int argc, char *argv[])
{
   ...
   const char *mesh_file = "./meshes/cubes-nurbs.mesh";//"./meshes/cubes-nurbs.mesh";"../../data/square-nurbs.mesh";
   int ref_levels = -1;
   bool NURBS = true;
   int order = 1;
   ...
   a.AddDomainIntegrator(new NURBSCurlCurlIntegrator(restr_c1_Re),new NURBSCurlCurlIntegrator(restr_c1_Im));
   ...
   a.AddDomainIntegrator(new NURBSHCurl_VectorMassIntegrator(restr_c2_Re),new NURBSHCurl_VectorMassIntegrator(restr_c2_Im));
