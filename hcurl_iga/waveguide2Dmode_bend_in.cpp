...
//
// Compile with: make waveguide2Dmode_bend_in
//
// Sample runs:  mpirun -np 1 waveguide2Dmode_bend_in
//
...
int main(int argc, char *argv[])
{
   ...
   ofstream sol_r_ofs("bend_in_nurbs-sol_r.gf");
   ofstream sol_i_ofs("bend_in_nurbs-sol_i.gf");
