...
//
// Compile with: make QAAQmode_mf_in_3
//
// Sample runs:  mpirun -np 1 QAAQmode_mf_in_3
//
...
int main(int argc, char *argv[])
{
   ...
   std::ifstream file_x_r("./mf_in_3_nurbs-sol_r.gf");
   std::ifstream file_x_i("./mf_in_3_nurbs-sol_i.gf");
   ...
   ofstream J_r_ofs("mf_in_3_J_r.gf");
   ofstream J_i_ofs("mf_in_3_J_i.gf");
   ...
   pd->SetPrefixPath("./MFin3Paraview");
