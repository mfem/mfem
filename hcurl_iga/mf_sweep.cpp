...
// nvcc  -g -Xcompiler=-Wall -std=c++11 -x=cu --expt-extended-lambda -arch=sm_86 -ccbin mpicxx -I../.. -I../../../hypre/src/hypre/include -I../../../metis/include mf_sweep.cpp -o mf_sweep -L../.. -lmfem -L../../../hypre/src/hypre/lib -lHYPRE -lcusparse -lcurand -lcublas -L../../../metis/lib -lmetis -lcusparse -lrt -lnlopt -lm
// Sample runs:  mpirun -np 1 mf_sweep
//
...
{  
   ...
   for(int freq_num = 0; freq_num < 1; freq_num++)
   {
    ...
    EMsolver_2.SetFrequency(1.0/(freq_num + fe));
    ...
    EMsolver_3.SetFrequency(1.0/(freq_num + fe));
