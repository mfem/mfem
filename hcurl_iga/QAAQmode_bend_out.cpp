...
//
// Compile with: make QAAQmode_bend_out
//
// Sample runs:  mpirun -np 1 QAAQmode_bend_out
//
...
int main(int argc, char *argv[])
{
   ...
   for (int i = 0; i < nelem; ++i)
   {
      ...
      for (int iv = 0; iv < nrvert; ++iv)
      {
         ...
         if ((coords[0] < 4800) && (coords[0] > 3200) && (coords[2] < 1200) && (coords[2] > 800))
         {
            is_waveguide = true;
            break;
         }
   ...
   std::ifstream file_x_r("./bend_out_nurbs-sol_r.gf");
   std::ifstream file_x_i("./bend_out_nurbs-sol_i.gf");
   ...
   ofstream J_r_ofs("bend_out_J_r.gf");
   ofstream J_i_ofs("bend_out_J_i.gf");
   ...
   pd->SetPrefixPath("./bendoutParaview");
