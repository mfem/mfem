...
public:
   ...
   /** Copy constructor. Performs a deep copy of (almost) all data, so that the
       ...
       nodes, if present. */
   // explicit MixedMesh(const Mesh &mesh, bool copy_nodes = true);

   /// Construct a MixedMesh from the given primary data.
   /** The array @a vertices is used as external data, i.e. the MixedMesh does not
       copy the data and will not delete the pointer.

       The data from the other arrays is copied into the internal MixedMesh data
       structures.
   ...
   MixedMesh(int _Dim, int NVert, int NElem, int NBdrElem = 0, int _spaceDim = -1)
   {
      if (_spaceDim == -1)
      {
         _spaceDim = _Dim;
   ...
   /** @name Methods for MixedMesh construction.
   ...
   /** This method does not require any actual coordinate data (either vertex
       ...
       After calling this method, setting the MixedMesh vertices or nodes, it may be
       appropriate to call the method Finalize(). */
   void FinalizeTopology();

   /// Finalize the construction of a general MixedMesh.
   /** This method will:
       ...
       @param[in] refine  If true, prepare the MixedMesh for conforming refinement of
       ...
       MixedMesh vertices or nodes are set. */
   ...
   explicit MixedMesh(int n, double sx = 1.0)
   {
      Make1D(n, sx);
   }
   ...
   MixedMesh(Mesh *orig_mesh, int ref_factor, int ref_type);
   ...
   */
   ...
   { this->GetElement(i)->GetVertices(v); }

   /// Returns the indices of the vertices of boundary element i.
   void GetBdrElementVertices(int i, Array<int> &v) const
   { this->GetBdrElement(i)->GetVertices(v); }
   ...
   { return this->GetElement(i)->GetAttribute(); }

   /// Set the attribute of element i.
   void SetAttribute(int i, int attr)
   { this->GetElement(i)->SetAttribute(attr); }

   /// Return the attribute of boundary element i.
   int GetBdrAttribute(int i) const
   { return this->GetBdrElement(i)->GetAttribute(); }
   ...
   Mesh::Operation GetLastOperation() const { return last_operation; }
...
// inline functions
inline void MixedMesh::ShiftL2R(int &a, int &b, int &c)
{
   int t = a;
   a = c;  c = b;  b = t;
}

inline void MixedMesh::Rotate3(int &a, int &b, int &c)
{
   if (a < b)
   {
      if (a > c)
