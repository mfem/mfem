        ...
        const int curved)
{
  ...
  while ((ent = apf_mesh->iterate(itr)))
  {
      ...
      if (apf_mesh->getModelType(mdEnt) == BCdim)
      {
          ...
          // this is to be deleted immediately 
          //int mdtag = apf_mesh->getModelTag(mdEnt);
          //if ((mdtag == 6921) || (mdtag == 5695)){
          //    attr = 2;
          //   std::cout << " MESH_pumi.cpp : " << apf_mesh->getModelTag(mdEnt)<<std::endl;
          //}
