...
public:
   ...
   */
   ...
   virtual void PrintXG(std::ostream &pout = mfem::out) const;

   /// Print the mesh to the given stream using the default MFEM mesh format.
   /// \see mfem::ofgzstream() for on-the-fly compression of ascii outputs
   virtual void Print(std::ostream &pout = mfem::out) const { Printer(pout); }
...
#ifdef MFEM_USE_ADIOS2
   virtual void Print(adios2stream &pout) const;
#endif
   /// Print the mesh in VTK format (linear and quadratic meshes only).
   /// \see mfem::ofgzstream() for on-the-fly compression of ascii outputs
   void PrintVTK(std::ostream &pout);
   ...
   /// \see mfem::ofgzstream() for on-the-fly compression of ascii outputs
   void PrintVTK(std::ostream &pout, int ref, int field_data=0);
   ...
   void PrintVTU(std::ostream &pout,
                 int ref=1,
   ...
   void PrintWithPartitioning (int *partitioning,
                               std::ostream &pout, int elem_attr = 0) const;
   ...
   */
   virtual void PrintInfo(std::ostream &pout = mfem::out)
   {
      PrintCharacteristics(NULL, NULL, pout);
   }
