...
protected:
   ...
   */
   ...
   /** Creates a mesh for the parallelepiped [0,sx]x[0,sy]x[0,sz], divided into
       nx*ny*nz*24 tetrahedrons. The mesh is generated by taking nx*ny*nz
       hexahedra and splitting each hexahedron into 24 tetrahedrons.
       Each face of the hexahedron is split into 4 triangles (face edges are
   ...
   */
   ...
   /** Creates mesh for the rectangle [0,sx]x[0,sy], divided into nx*ny*4
       triangles. The mesh is generated by taking nx*ny quadrilaterals and
       splitting each quadrilateral into 4 triangles by connecting the
       vertices to an quad-centered point.
   */
   void Make2D4TrisFromQuad(int nx, int ny, double sx, double sy);

   /** Creates mesh for the rectangle [0,sx]x[0,sy], divided into nx*ny*5
       quadrilaterals. The mesh is generated by taking nx*ny quadrilaterals and
       splitting each quadrilateral into 5 quadrilaterals.
       Each quadrilateral is projected inwards and connected to the original
       quadrilateral.
   */
...
public:
   ...
   */
   ...
   /// Adds 6 tetrahedrons to the mesh by splitting a hexahedron given by
   /// 8 vertices @a vi.
   void AddHexAsTets(const int *vi, int attr = 1);
   /// Adds 2 wedges to the mesh by splitting a hexahedron given by
   /// 8 vertices @a vi.
   void AddHexAsWedges(const int *vi, int attr = 1);
   /// Adds 6 pyramids to the mesh by splitting a hexahedron given by
   /// 8 vertices @a vi.
   ...
   /// Adds 4 triangles to the mesh by splitting a quadrilateral given by
   /// 4 vertices @a vi. @a attr is the attribute of the new elements.
   /// See @a Make2D4TrisFromQuad for usage.
   void AddQuadAs4TrisWithPoints(int *vi, int attr = 1);

   /// Adds 5 quadrilaterals to the mesh by splitting a quadrilateral given by
   /// 4 vertices @a vi. @a attr is the attribute of the new elements.
   /// See @a Make2D5QuadsFromQuad for usage.
