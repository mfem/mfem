...
public:
   ...
   */
   ...
   /// Adds 24 tetrahedrons to the mesh generated by splitting a hexahedron.
   ...
   /// Adds 4 triangles to the mesh generated by splitting a quadrilateral.
   /// @a vi are the 4 vertices of the quadrilateral, and @a attr is the
   /// attribute of the new elements. See @a Make2D4TrisFromQuad for usage.
   void AddQuadAs4TrisWithPoints(int *vi, int attr = 1);

   /// Adds 5 quadrilaterals to the mesh generated by splitting a quadrilateral.
   /// @a vi are the 4 vertices of the quadrilateral, and @a attr is the
   /// attribute of the new elements. See @a Make2D5QuadsFromQuad for usage.
