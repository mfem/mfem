...
protected:
   ...
   */
   ...
   /// quad-centered point.
   void Make2D4TrisFromQuad(int nx, int ny, fptype sx, fptype sy);
   ...
   void Make2D5QuadsFromQuad(int nx, int ny, fptype sx, fptype sy);
...
public:
   ...
   */
   ...
   /// quadrilateral into 4 triangles by connecting the vertices to a
   /// quad-centered point.
   static Mesh MakeCartesian2DWith4TrisPerQuad(int nx, int ny, fptype sx = 1.0,
                                               fptype sy = 1.0);
   ...
   /// each quadrilateral into 5 quadrilaterals. Each quadrilateral is projected
   /// inwards and connected to the original quadrilateral.
   static Mesh MakeCartesian2DWith5QuadsPerQuad(int nx, int ny, fptype sx = 1.0,
                                                fptype sy = 1.0);
