...
protected:
   ...
   fptype total_norm_p;
   fptype total_err_goal;
   fptype total_fraction;
   fptype local_err_goal;
   ...
   fptype GetNorm(const Vector &local_err, Mesh &mesh) const;
...
public:
   ...
   void SetTotalErrorNormP(fptype norm_p = infinity())
   { total_norm_p = norm_p; }

   /** @brief Set the total error stopping criterion: stop when
       total_err <= total_err_goal. The default value is zero. */
   void SetTotalErrorGoal(fptype err_goal) { total_err_goal = err_goal; }
   ...
   void SetTotalErrorFraction(fptype fraction) { total_fraction = fraction; }
   ...
   /** @brief Set the local stopping criterion: stop when
       ...
       computation. */
   void SetLocalErrorGoal(fptype err_goal) { local_err_goal = err_goal; }
   ...
   fptype GetThreshold() const { return threshold; }
...
public:
   ...
   void SetThreshold(fptype thresh) { threshold = thresh; }
...
protected:
   ...
   fptype threshold = 1.0e-2;
   fptype global_osc = NAN;
...
public:
   ...
   void SetThreshold(fptype threshold_) { threshold = threshold_; }
   ...
   fptype GetOsc() const { return global_osc; }
