...
{
   dbg("Erase");
   if (!h_ptr) { dbg("!h_ptr"); return MemoryType::HOST; }
                      ...
                      const size_t bytes, bool copy_data)
{
   ...
   dbg("PullAlias<%d>", alias.mem->type);
