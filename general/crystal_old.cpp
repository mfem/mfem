...
namespace mfem{
    CrystalRouterOld::CrystalRouterOld(MPI_Comm comm){
        MPI_Comm_dup(comm, &this->comm);
        MPI_Comm_rank(this->comm, &rank);
        MPI_Comm_size(this->comm, &nprocs);
    }

    CrystalRouterOld::~CrystalRouterOld(){
        MPI_Comm_free(&comm);
    }

    void CrystalRouterOld::Route(Array<int> &ranks, std::vector<Array<int>*> &int_data, std::vector<Array<real_t>*> &real_data){
...
// PRIVATE METHODS
    ...
    void CrystalRouterOld::Move(Array<int> &ranks, std::vector<Array<int>*> &int_data, std::vector<Array<real_t>*> &real_data,
    ...
    void CrystalRouterOld::Exchange(Array<int> &ranks,
