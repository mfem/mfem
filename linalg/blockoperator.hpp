...
public:
    ...
    */
   void SetDiagonalBlock(int iblock, Operator *op, fptype c = 1.0);
    ...
    * c: optional scalar multiple for this block.
    */
   void SetBlock(int iRow, int iCol, Operator *op, fptype c = 1.0);
   ...
   fptype GetBlockCoef(int i, int j) const
   { MFEM_VERIFY(op(i,j), ""); return coef(i,j); }
   //! Set the coefficient for block i,j
   void SetBlockCoef(int i, int j, fptype c)
