...
public:
     ...
     *          CuDSSSolver::MatType::UNSYMMETRIC (Default),
     *          CuDSSSolver::MatType::SYMMETRIC_INDEFINITE,
     *          CuDSSSolver::MatType::SYMMETRIC_INDEFINITE,
     *
     ...
     *
     * Supported matrix types:
     *          CuDSSSolver::MatViewType::FULL (Default),
     *          CuDSSSolver::MatViewType::LOWER,
     *          CuDSSSolver::MatViewType::UPPER,
     *
