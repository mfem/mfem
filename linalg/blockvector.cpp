...
//! View constructor
BlockVector::BlockVector(fptype *data, const Array<int> & bOffsets):
...
void BlockVector::Update(fptype *data, const Array<int> & bOffsets)
{
...
BlockVector & BlockVector::operator=(fptype val)
{
   Vector::operator=(val);
   return *this;
}
