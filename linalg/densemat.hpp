...
public:
    ...
    *
    * Constructor for the DenseMatrixSVD with LAPACK. The parameters for the left and right singular
    ...
    * @param [in] left_singular_vectors optional parameter to define if first left singular vectors should be computed
    ...
    *
    * Call of the DGESVD driver from LAPACK for the DenseMatrix M. The singular vectors are computed according to the setup
