...
namespace mfem {
  ...
  protected:
    ...
    virtual void MakePolytope(Mesh &mesh, const int elem_idx, Polytope &polygon) = 0;
  ...
  protected:
    void SetQuadratureRule(const IntegrationRule &ir) override;
    void MakePolytope(Mesh &mesh, const int elem_idx, Polyhedron_t &polyhedron) override;
