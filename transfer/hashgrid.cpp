...
void HashGrid::HashRange(const Vector &min, const Vector &max,
...
void BuildBoxes(const Mesh &mesh, std::vector<Box> &element_boxes,
                Box &mesh_box)
{
...
bool DetectIntersections(const Mesh &src, const Mesh &dest,
                         std::vector<int> &pairs)
{
