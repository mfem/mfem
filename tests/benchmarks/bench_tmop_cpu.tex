...
\newcommand{\MPICPU}{bench_tmop_lassen_cpu_x40.org}
...
\begin{semilogxaxis}[
    ...
    %title={TMOP-AddMultGradPA @ 40x Lassen cores},
    ymax=2.2,
    ymin=0,
    xmin=1e4,
    xmax=10e6
  ]
  \addplot +[raw gnuplot] gnuplot { set datafile separator ','; plot "\MPICPU" using ($11):($13==1?$12/1000:NaN) smooth sbezier};
  \addplot +[raw gnuplot] gnuplot { set datafile separator ','; plot "\MPICPU" using ($11):($13==2?$12/1000:NaN) smooth sbezier};
  \addplot +[raw gnuplot] gnuplot { set datafile separator ','; plot "\MPICPU" using ($11):($13==3?$12/1000:NaN) smooth sbezier};
  \addplot +[raw gnuplot] gnuplot { set datafile separator ','; plot "\MPICPU" using ($11):($13==4?$12/1000:NaN) smooth sbezier};
