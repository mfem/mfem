...
%\newcommand{\DATA}{bp1_mi250_1xGCD_fast7_rocm4.5.0_boosted.org}
%\newcommand{\TITLE}{BP1 @ 1/2-MI250X, rocm/4.5.0 boosted}
%\newcommand{\XMIN}{2e3}
%\newcommand{\XMAX}{4e6}

\newcommand{\DATA}{bp1_mi250_2xGCD_fast7_rocm4.5.0_boosted.org}
\newcommand{\TITLE}{BP1 @ Full-MI250X, rocm/4.5.0 boosted}
\newcommand{\XMIN}{2e3}
\newcommand{\XMAX}{1e7}
...
\begin{semilogxaxis}[
  ...
  \addplot +[raw gnuplot] gnuplot { set datafile separator ','; plot "\DATA" using ($11):($13==1?$12/1e3:NaN) smooth sbezier};
  \addplot +[raw gnuplot] gnuplot { set datafile separator ','; plot "\DATA" using ($11):($13==2?$12/1e3:NaN) smooth sbezier};
  \addplot +[raw gnuplot] gnuplot { set datafile separator ','; plot "\DATA" using ($11):($13==3?$12/1e3:NaN) smooth sbezier};
  \addplot +[raw gnuplot] gnuplot { set datafile separator ','; plot "\DATA" using ($11):($13==4?$12/1e3:NaN) smooth sbezier};
  \addplot +[raw gnuplot] gnuplot { set datafile separator ','; plot "\DATA" using ($11):($13==5?$12/1e3:NaN) smooth sbezier};
  \addplot +[raw gnuplot] gnuplot { set datafile separator ','; plot "\DATA" using ($11):($13==6?$12/1e3:NaN) smooth sbezier};
