...
\newcommand{\LEGCY}{bench_tmop_lassen.org}
\newcommand{\FAST}{bench_tmop_lassen_fast.org}
\newcommand{\MPIGPU}{bench_tmop_lassen_mpi_4.org}
\newcommand{\MPICPU}{bench_tmop_lassen_cpu_mpi_20.org}

\newcommand{\DATA}{\MPICPU}
...
\begin{semilogxaxis}[
    ...
    legend entries={$p=4$ (CPUs), $p=4$ (GPUs)},
  ...
  %\addplot +[raw gnuplot] gnuplot { set datafile separator ','; plot "\DATA" using ($11):($13==1?$12:NaN)};
  %\addplot +[raw gnuplot] gnuplot { set datafile separator ','; plot "\DATA" using ($11):($13==2?$12:NaN)};
  %\addplot +[raw gnuplot] gnuplot { set datafile separator ','; plot "\DATA" using ($11):($13==3?$12:NaN)};
  \addplot +[raw gnuplot] gnuplot { set datafile separator ','; plot "\MPICPU" using ($11):($13==4?$12/1000:NaN)};
  \addplot +[raw gnuplot] gnuplot { set datafile separator ','; plot "\MPIGPU" using ($11):($13==4?$12/1000:NaN)};
