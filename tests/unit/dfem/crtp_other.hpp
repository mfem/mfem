...
#include "fem/dfem/crtp_base.hpp"
...
class OtherDifferentiableOperator final :
   public BackendOperator<OtherDifferentiableOperator>
{
public:
   OtherDifferentiableOperator(
      const std::vector<FieldDescriptor> &solutions,
      const std::vector<FieldDescriptor> &parameters,
      const ParMesh &mesh):
      BackendOperator<OtherDifferentiableOperator>
