...
void * __enzyme_augmentfwd(void *, real_t *, real_t *);
void __enzyme_reverse(void *, real_t *, real_t *, void *);
void __enzyme_autodiff(void *, real_t *, real_t *);
          ...
          "[Enzyme][SplitReverse]")
{
   ...
   void *tape = __enzyme_augmentfwd((void *)myQF, x, x_bar);
   __enzyme_reverse((void *)myQF, x, x_bar, tape);

   __enzyme_autodiff((void *)myQF, y, y_bar);
