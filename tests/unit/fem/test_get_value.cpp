          ...
          "[GridFunctionCoefficient]")
{
        ...
        type <= (int)Element::SEGMENT; type++)
   {
      ...
      SECTION("1D GetValue tests for element type " + std::to_string(type))
      {
         ...
         SECTION("Domain Evaluation 1D (H1 Context)")
         {
            std::cout << "Domain Evaluation 1D (H1 Context)" << std::endl;
         ...
         SECTION("Domain Evaluation 1D (DG Context)")
         {
            std::cout << "Domain Evaluation 1D (DG Context)" << std::endl;
            for (int e = 0; e < mesh.GetNE(); e++)
            {
               ElementTransformation *T = mesh.GetElementTransformation(e);
          ...
          "[GridFunctionCoefficient]")
{
        ...
        type <= (int)Element::QUADRILATERAL; type++)
   {
      ...
      SECTION("2D GetValue tests for element type " + std::to_string(type))
      {
         ...
         SECTION("Domain Evaluation 2D (H1 Context)")
         {
            std::cout << "Domain Evaluation 2D (H1 Context)" << std::endl;
            for (int e = 0; e < mesh.GetNE(); e++)
            {
               ElementTransformation *T = mesh.GetElementTransformation(e);
               const FiniteElement   *fe = h1_fespace.GetFE(e);
         ...
         SECTION("Domain Evaluation 2D (DG Context)")
         {
            std::cout << "Domain Evaluation 2D (DG Context)" << std::endl;
            for (int e = 0; e < mesh.GetNE(); e++)
            {
               ElementTransformation *T = mesh.GetElementTransformation(e);
               const FiniteElement   *fe = dgv_fespace.GetFE(e);
          ...
          "[VectorGridFunctionCoefficient]")
{
        ...
        type <= (int)Element::QUADRILATERAL; type++)
   {
      ...
      VectorFunctionCoefficient linCoef(2, Func_2D_lin);
              ...
              std::to_string(type))
      {
         ...
         Vector      f_val(2);      f_val = 0.0;
         Vector  h1_gf_val(2);  h1_gf_val = 0.0;
         Vector  nd_gf_val(2);  nd_gf_val = 0.0;
         Vector  rt_gf_val(2);  rt_gf_val = 0.0;
         Vector  l2_gf_val(2);  l2_gf_val = 0.0;
         Vector dgv_gf_val(2); dgv_gf_val = 0.0;
         Vector dgi_gf_val(2); dgi_gf_val = 0.0;
          ...
          "[VectorGridFunctionCoefficient]")
{
        ...
        type <= (int)Element::HEXAHEDRON; type++)
   {
      ...
      VectorFunctionCoefficient linCoef(3, Func_3D_lin);
          ...
          "[GradientGridFunctionCoefficient]")
{
        ...
        type <= (int)Element::WEDGE; type++)
   {
      ...
      FunctionCoefficient quadCoef(func_3D_quad);
