          ...
          "[ODE1]")
{
   ...
   SECTION("BackwardEuler")
   {
      ...
      int conv_rate = check.order(new BackwardEulerSolver);
   ...
   SECTION("SDIRK23Solver(2)")
   {
      ...
      int conv_rate = check.order(new SDIRK23Solver(2));
   ...
   SECTION("SDIRK33Solver")
   {
      ...
      int conv_rate = check.order(new SDIRK33Solver);
   ...
   SECTION("ForwardEulerSolver")
   {
      ...
      int conv_rate = check.order(new ForwardEulerSolver);
      REQUIRE(conv_rate + tol > 1.0);
   }
   ...
   SECTION("RK2Solver(0.5)")
   {
      ...
      int conv_rate = check.order(new RK2Solver(0.5));
      REQUIRE(conv_rate + tol > 2.0);
   }
   ...
   SECTION("RK3SSPSolver")
   {
      ...
      int conv_rate = check.order(new RK3SSPSolver);
      REQUIRE(conv_rate + tol > 3.0);
   }
   ...
   SECTION("RK4Solver")
   {
      ...
      int conv_rate = check.order(new RK4Solver);
   ...
   SECTION("ImplicitMidpointSolver")
   {
      ...
      int conv_rate = check.order(new ImplicitMidpointSolver);
      REQUIRE(conv_rate + tol > 2.0);
   }
   ...
   SECTION("SDIRK23Solver")
   {
      ...
      int conv_rate = check.order(new SDIRK23Solver);
      REQUIRE(conv_rate + tol > 3.0);
   }
   ...
   SECTION("SDIRK34Solver")
   {
      ...
      int conv_rate = check.order(new SDIRK34Solver);
      REQUIRE(conv_rate + tol > 4.0);
   }
   ...
   SECTION("GeneralizedAlphaSolver(1.0)")
   {
      ...
      int conv_rate = check.order(new GeneralizedAlphaSolver(1.0));
      REQUIRE(conv_rate + tol > 2.0);
   }
   ...
   SECTION("GeneralizedAlphaSolver(0.5)")
   {
      ...
      int conv_rate = check.order(new GeneralizedAlphaSolver(0.5));
      REQUIRE(conv_rate + tol > 2.0);
   }
   ...
   SECTION("GeneralizedAlphaSolver(0.5) - restart")
   {
      ...
      int conv_rate = check.order(new GeneralizedAlphaSolver(0.5), true);
      REQUIRE(conv_rate + tol > 2.0);
   }
   ...
   SECTION("GeneralizedAlphaSolver(0.0)")
   {
      ...
      int conv_rate = check.order(new GeneralizedAlphaSolver(0.0));
      REQUIRE(conv_rate + tol > 2.0);
   }
   ...
   SECTION("AB1Solver()")
   {
      ...
      int conv_rate = check.order(new AB1Solver());
      REQUIRE(conv_rate + tol > 1.0);
   }
   ...
   SECTION("AB1Solver() - restart")
   {
      ...
      int conv_rate = check.order(new AB1Solver(), true);
      REQUIRE(conv_rate + tol > 1.0);
   }
   ...
   SECTION("AB2Solver()")
   {
      ...
      int conv_rate = check.order(new AB2Solver());
      REQUIRE(conv_rate + tol > 2.0);
   }
   ...
   SECTION("AB2Solver() - restart")
   {
      ...
      int conv_rate = check.order(new AB2Solver(), true);
      REQUIRE(conv_rate + tol > 2.0);
   }
   ...
   SECTION("AB3Solver()")
   {
      ...
      int conv_rate = check.order(new AB3Solver());
      REQUIRE(conv_rate + tol > 3.0);
   }
   ...
   SECTION("AB4Solver()")
   {
      ...
      int conv_rate = check.order(new AB4Solver());
      REQUIRE(conv_rate + tol > 4.0);
   }
   ...
   SECTION("AB5Solver()")
   {
      ...
      int conv_rate = check.order(new AB5Solver());
   ...
   SECTION("AB5Solver() - restart")
   {
      ...
      int conv_rate = check.order(new AB5Solver(), true);
      REQUIRE(conv_rate + tol > 5.0);
   }
   ...
   SECTION("AM0Solver()")
   {
      ...
      int conv_rate = check.order(new AM0Solver());
      REQUIRE(conv_rate + tol > 1.0);
   }
   ...
   SECTION("AM1Solver()")
   {
      ...
      int conv_rate = check.order(new AM1Solver());
      REQUIRE(conv_rate + tol > 2.0);
   }
   ...
   SECTION("AM1Solver() - restart")
   {
      ...
      int conv_rate = check.order(new AM1Solver(), true);
      REQUIRE(conv_rate + tol > 2.0);
   }
   ...
   SECTION("AM2Solver()")
   {
      ...
      int conv_rate = check.order(new AM2Solver());
      REQUIRE(conv_rate + tol > 3.0);
   }
   ...
   SECTION("AM2Solver() - restart")
   {
      ...
      int conv_rate = check.order(new AM2Solver(), true);
      REQUIRE(conv_rate + tol > 1.0);
   }
   ...
   SECTION("AM3Solver()")
   {
      ...
      int conv_rate = check.order(new AM3Solver());
      REQUIRE(conv_rate + tol > 4.0);
   }
   ...
   SECTION("AM4Solver()")
   {
      ...
      int conv_rate = check.order(new AM4Solver());
      REQUIRE(conv_rate + tol > 5.0);
   }
   ...
   SECTION("AM4Solver() - restart")
   {
      ...
      int conv_rate = check.order(new AM4Solver(),true);
      REQUIRE(conv_rate + tol > 5.0);
   }
}
