...
TEST_CASE("Exponential", "[DenseMatrix]")
{
   ...
   expA(0,0) = std::exp(9.0) * (std::sin(std::sqrt(3.0)) / std::sqrt(3.0) + std::cos(std::sqrt(3.0)));
   expA(0,1) = 2.0 * std::exp(9.0) * std::sin(std::sqrt(3.0)) / std::sqrt(3.0);
   expA(1,0) = - 2.0 * std::exp(9.0) * std::sin(std::sqrt(3.0))  / std::sqrt(3.0);
   expA(1,1) = std::exp(9.0) * (std::cos(std::sqrt(3.0)) - std::sin(std::sqrt(3.0)) / std::sqrt(3.0));
