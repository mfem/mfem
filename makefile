...
MFEM_DEFINES = MFEM_VERSION MFEM_VERSION_STRING MFEM_GIT_STRING MFEM_USE_MPI    \
 ...
 MFEM_USE_OCCA MFEM_USE_MM MFEM_USE_MMU MFEM_USE_RAJA

# List of makefile variables that will be written to config.mk:
MFEM_CONFIG_VARS = MFEM_CXX MFEM_CPPFLAGS MFEM_CXXFLAGS MFEM_INC_DIR            \
 MFEM_TPLFLAGS MFEM_INCFLAGS MFEM_PICFLAG MFEM_SOFLAGS MFEM_FLAGS               \
 MFEM_LINK_FLAGS MFEM_LIB_DIR MFEM_EXT_LIBS MFEM_LIBS MFEM_LIB_FILE MFEM_STATIC \
...
status info:
	...
	$(info MFEM_USE_MMU         = $(MFEM_USE_MMU))
