...
MINIAPP_USE_COMMON := $(addprefix miniapps/,electromagnetics meshing tools \
 toys shifted dpg diag-smoothers contact)
...
MINIAPPS_SUBDIRS = dpg/util hooke/operators hooke/preconditioners hooke/materials hooke/kernels contact/ipsolver contact/problems
