...
MFEM_DEFINES = MFEM_VERSION MFEM_VERSION_STRING MFEM_GIT_STRING MFEM_USE_MPI\
 ...
 MFEM_SOURCE_DIR MFEM_INSTALL_DIR MFEM_SHARED_BUILD MFEM_USE_SYCL MFEM_USE_DOUBLE MFEM_USE_SINGLE
...
DIRS = general linalg linalg/simd linalg/batched mesh mesh/submesh fem \
       ...
       fem/qinterp fem/integ fem/tmop general/backends
...
status info:
	...
	$(info MFEM_USE_SYCL          = $(MFEM_USE_SYCL))
