...
ifneq ($(MFEM_USE_MPI),YES)
   MFEM_HOST_CXX = $(CXX)
   PKGS_NEED_MPI = SUPERLU MUMPS PASTIX STRUMPACK PETSC PUMI SLEPC MKL_CPARDISO
...
MFEM_REQ_LIB_DEPS = SUPERLU MUMPS METIS CONDUIT SIDRE LAPACK SUNDIALS MESQUITE\
 ...
 OCCA CEED RAJA UMPIRE MKL_CPARDISO AMGX PASTIX
...
MFEM_DEFINES = MFEM_VERSION MFEM_VERSION_STRING MFEM_GIT_STRING MFEM_USE_MPI\
 ...
 MFEM_USE_MKL_CPARDISO MFEM_USE_AMGX MFEM_USE_MUMPS MFEM_USE_PASTIX\
...
status info:
	...
	$(info MFEM_USE_PASTIX        = $(MFEM_USE_PASTIX))
