...
MINIAPP_SUBDIRS = common electromagnetics meshing navier performance tools \
 toys nurbs gslib adjoint solvers shifted mtop parelag tribol axom autodiff \
...
MFEM_REQ_LIB_DEPS = ENZYME SUPERLU MUMPS METIS FMS CONDUIT SIDRE LAPACK SUNDIALS\
 ...
 AXOM BENCHMARK MOONOLITH ALGOIM
...
MFEM_DEFINES = MFEM_VERSION MFEM_VERSION_STRING MFEM_GIT_STRING MFEM_USE_MPI\
 ...
 MFEM_USE_BENCHMARK MFEM_USE_PARELAG MFEM_USE_TRIBOL MFEM_USE_AXOM MFEM_USE_ALGOIM\
 MFEM_USE_ENZYME MFEM_SOURCE_DIR MFEM_INSTALL_DIR MFEM_SHARED_BUILD
...
status info:
	...
	$(info MFEM_USE_AXOM          = $(MFEM_USE_AXOM))
