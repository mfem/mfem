...
EXAMPLE_SUBDIRS = amgx caliper ginkgo hiop petsc pumi sundials superlu moonolith cudss
...
ifneq ($(MFEM_USE_MPI),YES)
   HOST_CXX = $(CXX)
   PKGS_NEED_MPI = SUPERLU MUMPS STRUMPACK PETSC PUMI SLEPC MKL_CPARDISO CUDSS
