...
MFEM_DEFINES = MFEM_VERSION MFEM_VERSION_STRING MFEM_GIT_STRING MFEM_USE_MPI\
 ...
 MFEM_USE_OCCA MFEM_USE_CEED MFEM_USE_RAJA MFEM_USE_UMPIRE\
 MFEM_UMPIRE_HOST MFEM_UMPIRE_DEVICE MFEM_SOURCE_DIR MFEM_INSTALL_DIR
...
status info:
	...
	$(info MFEM_UMPIRE_HOST       = $(value MFEM_UMPIRE_HOST))
	$(info MFEM_UMPIRE_DEVICE     = $(value MFEM_UMPIRE_DEVICE))
