...
MFEM_REQ_LIB_DEPS = SUPERLU MUMPS METIS FMS CONDUIT SIDRE LAPACK SUNDIALS MESQUITE\
 ...
 OCCA CEED RAJA UMPIRE MKL_CPARDISO AMGX CALIPER PARELAG BENCHMARK ALGOIM BLITZ
...
MFEM_DEFINES = MFEM_VERSION MFEM_VERSION_STRING MFEM_GIT_STRING MFEM_USE_MPI\
 ...
 MFEM_USE_PARELAG MFEM_SOURCE_DIR MFEM_INSTALL_DIR MFEM_USE_BLITZ MFEM_USE_ALGOIM
...
status info:
	...
	$(info MFEM_USE_BLITZ         = $(MFEM_USE_BLITZ))
