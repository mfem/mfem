...
ifneq ($(MFEM_USE_MPI),YES)
   MFEM_HOST_CXX = $(CXX)
   PKGS_NEED_MPI = SUPERLU STRUMPACK PASTIX PETSC PUMI SLEPC
...
MFEM_DEFINES = MFEM_VERSION MFEM_VERSION_STRING MFEM_GIT_STRING MFEM_USE_MPI\
 ...
 MFEM_USE_SUPERLU MFEM_USE_STRUMPACK MFEM_USE_PASTIX MFEM_USE_GNUTLS\
