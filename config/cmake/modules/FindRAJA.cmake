...
if (RAJA_DIR)
   ...
   # As a workaround for an issue in raja-config.cmake we try to load
   # bltTargets.cmake before calling find_package(RAJA ...).
   if (NOT RAJA_BLT_TARGETS)
      set(RAJA_BLT_TARGETS "${RAJA_DIR}/lib/cmake/raja/bltTargets.cmake")
   endif()
   if (EXISTS "${RAJA_BLT_TARGETS}")
      include("${RAJA_BLT_TARGETS}")
   endif()
