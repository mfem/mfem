...
GINKGO_LIB_DIR = $(sort $(dir $(wildcard $(GINKGO_SEARCH_DIR)/lib*/libginkgo*.a  $(GINKGO_SEARCH_DIR)/lib*/libginkgo*.so $(GINKGO_SEARCH_DIR)/lib*/libginkgo*.dylib $(GINKGO_SEARCH_DIR)/lib*/libginkgo*.dll)))
GINKGO_LINK_LIB_DIR = $(GINKGO_DIR)$(subst $(GINKGO_SEARCH_DIR),,$(GINKGO_LIB_DIR))
ALL_GINKGO_LIBS_DEBUG = $(notdir $(basename $(wildcard $(GINKGO_SEARCH_DIR)/lib*/libginkgo*d.a  $(GINKGO_SEARCH_DIR)/lib*/libginkgo*d.so $(GINKGO_SEARCH_DIR)/lib*/libginkgo*d.dylib $(GINKGO_SEARCH_DIR)/lib*/libginkgo*d.dll)))
ALL_GINKGO_LIBS = $(notdir $(basename $(wildcard $(GINKGO_SEARCH_DIR)/lib*/libginkgo*.a  $(GINKGO_SEARCH_DIR)/lib*/libginkgo*.so $(GINKGO_SEARCH_DIR)/lib*/libginkgo*.dylib $(GINKGO_SEARCH_DIR)/lib*/libginkgo*.dll)))
...
GINKGO_LIB = $(XLINKER)-rpath,$(GINKGO_LINK_LIB_DIR) -L$(GINKGO_LINK_LIB_DIR) $(GINKGO_LINK)
