...
IF (DEFINED TPL_ENABLE_UMPIRE)
  ...
  SET(MFEM_UMPIRE_HOST ${MFEM_UMPIRE_HOST} CACHE STRING "Umpire host allocator name" FORCE)
  SET(MFEM_UMPIRE_DEVICE ${MFEM_UMPIRE_DEVICE} CACHE STRING "Umpire device allocator name" FORCE)
ENDIF()
